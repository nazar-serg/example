      ...
      <div class="row">
        ...
        ?>
            <div class="page-content">
              <div class="picture-for-individuals"></div>
              ...
              <div class="btn-order-services">
                ...
                <div class="stages-our-work">
                  <div class="container">
                    <h2>Почему стоит доверить тепловизорное обследование именно нам?</h2>
                    <div class="row column">
                      <div class="col-lg-3 item">
                        <div class="feature-panel-text">
                          <p class="counter number">01</p>
                          <p>Онлайн-отчётность</p>
                        </div>
                      </div>
                      <div class="col-lg-3 item">
                        <div class="feature-panel-text">
                          <p class="counter number">02</p>
                          <p>Современное оборудование</p>
                        </div>
                      </div>
                      <div class="col-lg-3 item">
                        <div class="feature-panel-text">
                          <p class="counter number">03</p>
                          <p>Минимальные сроки</p>
                        </div>
                      </div>
                      <div class="col-lg-3 item">
                        <div class="feature-panel-text">
                          <p class="counter number">04</p>
