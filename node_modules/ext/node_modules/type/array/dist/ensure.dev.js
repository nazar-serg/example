...
/*, options*/
  ...
  var mainErrorMessage = options && options.name ? "Expected an array for %n, received %v" : "%v is not an array";
  ...
  if (ensureItem) {
    ...
    if (invalidItems) {
      throw new TypeError(resolveErrorMessage(mainErrorMessage, value, options) + ".\n           Following items are invalid: " + invalidItems.join(", "));
    }
