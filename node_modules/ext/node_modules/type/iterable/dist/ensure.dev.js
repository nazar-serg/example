...
/*, options*/
  ...
  var mainErrorMessage = options && options.name ? "Expected an iterable for %n, received %v" : "%v is not expected iterable";
  ...
  if (ensureItem) {
    ...
    if (invalidItems) {
      var errorMessage = resolveErrorMessage(mainErrorMessage, value, options) + ".\n           Following items are invalid:";
