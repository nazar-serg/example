  ...
  function runNode(option) {
    ...
    execFile(process.execPath, [option], function (execErr, result) {
      ...
      if (index >= 0) {
        ...
        if (matchedFlags) {
          flags = flags.concat(matchedFlags.map(normalizeFlagName).filter(function (name) {
