...
tap.test("extract test", function (t) {
  ...
  var inp = fs.createReadStream(file); // give it a weird buffer size to try to break in odd places

  inp.bufferSize = 1234;
  inp.pipe(extract);
  extract.on("end", function () {
    t.equal(ee, expectEntries.length, "should see " + ee + " entries"); // should get no more entries after end
  ...
  function next() {
    var r = fstream.Reader({
      path: target,
      type: "Directory" // this is just to encourage consistency
      ,
      sort: "alpha"
    });
    r.on("ready", function () {
