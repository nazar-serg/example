...
var tap = require("tap"),
    ...
    entries = // the global header and root fixtures/ dir are going to get
...
function runTest(t, doGH, doFromBase) {
  ...
  var pack = Pack(props);
  var writer = Writer(target); // skip the global header if we're not doing that.
