...
coerce.string = function (value) {
  if (value != null && _typeof(value) === 'object' && typeof value.toString === 'function') {
...
function primitive(value) {
  if (value != null && _typeof(value) === 'object' && typeof value.valueOf === 'function') {
    value = value.valueOf();
  }
