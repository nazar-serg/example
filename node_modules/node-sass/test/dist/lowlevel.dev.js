...
describe('lowlevel', function () {
  ...
  it('data context with options.data not provided', function (done) {
    ...
    binding.renderSync(options);
    assert(/Data context created without a source string/.test(options.result.error), 'Should fail with error message "Data context created without a source string"');
    done();
  });
  ...
  it('file context with both options.data and options.file not provided', function (done) {
    ...
    assert(/File context created without an input path/.test(options.result.error), 'Should fail with error message "File context created without an input path"');
    done();
  });
  ...
  it('empty data string', function (done) {
    ...
    binding.renderSync(options);
    assert(/empty source string/.test(options.result.error), 'Should fail with error message "Data context created with empty source string"');
    done();
  });
  it('empty file string', function (done) {
    ...
    binding.renderFileSync(options);
    assert(/empty input path/.test(options.result.error), 'Should fail with error message "File context created with empty input path"');
    done();
  });
}); // lowlevel