...
describe('sass.types', function () {
  describe('Boolean', function () {
    ...
    it('implements getValue', function () {
      var t = sass.types.Boolean(true);
      assert.equal(_typeof(t.getValue), 'function');
      assert.equal(t.getValue(), true);
      var f = sass.types.Boolean(false);
      assert.equal(_typeof(f.getValue), 'function');
  ...
  describe('Error', function () {
    ...
    it('supports call constructor', function () {
      ...
      assert.equal(e.toString(), '[object SassError]'); // TODO: I'm not sure this object works well, it likely needs to be fleshed out more...
    });
    it('supports new constructor', function () {
  ...
  describe('Map', function () {
    ...
    it('supports an optional constructor argument', function () {
      ...
      assert["throws"](function () {
        ...
        assert.equal(error.message, 'First argument should be an integer.'); // TODO: TypeError
