...
function noop() {} // The sorting of the levels is
// significant.


var levels = ['error', // -L: Logs error events.
...
function toConsole(log, opts) {
  ...
  cleanup(log); // Return immediately if logging is
  // not desired.
