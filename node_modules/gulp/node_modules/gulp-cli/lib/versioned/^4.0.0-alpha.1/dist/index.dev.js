...
function execute(opts, env, config) {
  ...
  logEvents(gulpInst);
  logSyncTask(gulpInst, opts); // This is what actually loads up the gulpfile
  ...
  requireOrImport(env.configPath, function (err, exported) {
    ...
    registerExports(gulpInst, exported); // Always unmute stdout after gulpfile is required
