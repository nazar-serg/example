...
var configure = requireInject('../lib/configure', {
  'graceful-fs': {
    ...
    'openSync': function openSync(path) {
...
var readableFiles = [path.resolve(dir, readableFile), path.resolve(dir, anotherReadableFile), path.resolve(dir, readableFileInDir)];
