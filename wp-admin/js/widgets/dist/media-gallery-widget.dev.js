  ...
  /** @lends wp.mediaWidgets.controlConstructors.media_gallery.prototype */
  {
    ...
    editMedia: function editMedia() {
      ...
      mediaFrame.on('update', function onUpdate(newSelection) {
        ...
        control.selectedAttachments.reset(resultSelection.models); // Update models in the widget instance.
    ...
    selectMedia: function selectMedia() {
      ...
      mediaFrame.on('update', function onUpdate(newSelection) {
        ...
        control.selectedAttachments.reset(resultSelection.models); // Update widget instance.
