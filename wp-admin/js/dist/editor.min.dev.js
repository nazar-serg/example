  ...
  u.editor = u.editor || {}, window.switchEditors = new function () {
    ...
    function n(e, t) {
      ...
      if ("tmce" === (t = "toggle" === t ? u && !u.isHidden() ? "html" : "tmce" : t) || "tinymce" === t) {
        ...
        void 0 !== window.QTags && window.QTags.closeAllTags(e), n = parseInt(m.style.height, 10) || 0;
        !(u ? u.getParam("wp_keep_scroll_position") : window.tinyMCEPreInit.mceInit[e] && window.tinyMCEPreInit.mceInit[e].wp_keep_scroll_position) || (o = f) && o.length && (c = o[0], p = function (e, t) {
          var n = t.cursorStart,
              r = t.cursorEnd,
              t = x(e, n);
          ...
          cursorStart: c.selectionStart,
          cursorEnd: c.selectionEnd
        ...
        if (u && u.isHidden()) return !1;
        u ? (h.Env.iOS || (n = (t = u.iframeElement) ? parseInt(t.style.height, 10) : 0) && 50 < (n = n + v(u) - 14) && n < 5e3 && (m.style.height = n + "px"), n = null, u.getParam("wp_keep_scroll_position") && (n = function (e) {
          ...
          e.on("GetContent", _);
          o = $(e.getContent());
          e.off("GetContent", _), i.remove(), a.remove();
          e = new RegExp('<span[^>]*\\s*class="mce_SELRES_start"[^>]+>\\s*' + n + "[^<]*<\\/span>(\\s*)"), i = new RegExp('(\\s*)<span[^>]*\\s*class="mce_SELRES_end"[^>]+>\\s*' + n + "[^<]*<\\/span>"), a = o.match(e), n = o.match(i);
          if (!a) return null;
          e = a.index, o = a[0].length, i = null;
          n && (-1 !== a[0].indexOf("data-mce-object-selection") && (o -= a[1].length), a = n.index, -1 !== n[0].indexOf("data-mce-object-selection") && (a -= n[1].length), i = a - o);
          return {
            start: e,
            end: i
          };
        }(u)), u.hide(), n && (u = u, (n = n) && (r = u.getElement(), i = n.start, a = n.end || n.start, r.focus && setTimeout(function () {
          r.setSelectionRange(i, a), r.blur && r.blur(), r.focus();
        }, 100)))) : f.css({
          display: "",
          visibility: ""
        }), w.removeClass("tmce-active").addClass("html-active"), f.attr("aria-hidden", !1), window.setUserSetting("editor", "html");
      }
    }
    ...
    function $(e) {
      ...
      return e ? (-1 !== (e = -1 !== e.indexOf("<script") || -1 !== e.indexOf("<style") ? e.replace(/<(script|style)[^>]*>[\s\S]*?<\/\1>/g, function (e) {
      ...
      }) : e).indexOf("<pre") && (i = !0, e = e.replace(/<pre[^>]*>[\s\S]+?<\/pre>/g, function (e) {
        return (e = (e = e.replace(/<br ?\/?>(\r\n|\n)?/g, "<wp-line-break>")).replace(/<\/?p( [^>]*)?>(\r\n|\n)?/g, "<wp-line-break>")).replace(/\r?\n/g, "<wp-line-break>");
      })), -1 !== e.indexOf("[caption") && (t = !0, e = e.replace(/\[caption[\s\S]+?\[\/caption\]/g, function (e) {
        ...
        return e.replace(/[\r\n]+/g, "");
      }) : e).replace(/<\/p#>/g, "</p>\n")).replace(/\s*(<p [^>]+>[\s\S]*?<\/p>)/g, "\n$1")).replace(/^\s+/, "")).replace(/[\s\u00a0]+$/, ""), i && (e = e.replace(/<wp-line-break>/g, "\n")), t && (e = e.replace(/<wp-temp-br([^>]*)>/g, "<br$1>")), e = a.length ? e.replace(/<wp-preserve>/g, function () {
        return a.shift();
      }) : e) : "";
    }
    ...
    }), g ? g(document).ready(e) : document.addEventListener ? (document.addEventListener("DOMContentLoaded", e, !1), window.addEventListener("load", e, !1)) : window.attachEvent && (window.attachEvent("onload", e), document.attachEvent("onreadystatechange", function () {
