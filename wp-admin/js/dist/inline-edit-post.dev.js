...
(function ($, wp) {
  window.inlineEditPost = {
    ...
    init: function init() {
      ...
      $('#bulk-edit').find('fieldset:first').after($('#inline-edit fieldset.inline-edit-categories').clone()).siblings('fieldset:last').prepend($('#inline-edit label.inline-edit-tags').clone());
        ...
        if (r) {
          if (-1 !== r.indexOf('<tr')) {
            ...
            $(inlineEditPost.what + id).hide().fadeIn(400, function () {
              ...
              $(this).find('.editinline').attr('aria-expanded', 'false').focus();
