...
!function (r) {
  ...
  O.fn.attr2 = function () {
    ...
    if (F.data && (n = O.isFunction(F.data) ? F.data(a) : F.data, F.extraData = n, c = O.param(n, r)), F.beforeSubmit && !1 === F.beforeSubmit(a, this, F)) return C("ajaxSubmit: submit aborted via beforeSubmit callback"), this;
    ...
    var n = O.param(a, r);
    c && (n = n ? n + "&" + c : c), "GET" === F.type.toUpperCase() ? (F.url += (0 <= F.url.indexOf("?") ? "&" : "?") + n, F.data = null) : F.data = n;
    var o,
        i,
        s,
        u = [];
    F.resetForm && u.push(function () {
      E.resetForm();
    }), F.clearForm && u.push(function () {
      E.clearForm(F.includeHidden);
    }), !F.dataType && F.target ? (o = F.success || function () {}, u.push(function (e, t, r) {
      var a = arguments,
          n = F.replaceTarget ? "replaceWith" : "html";
      O(F.target)[n](e).each(function () {
        o.apply(this, a);
      });
    })) : F.success && (O.isArray(F.success) ? O.merge(u, F.success) : u.push(F.success)), F.success = function (e, t, r) {
      for (var a = F.context || this, n = 0, o = u.length; n < o; n++) {
        u[n].apply(a, [e, t, r || E, E]);
      }
    ...
    var t = 0 < O("input[type=file]:enabled", this).filter(function () {
      return "" !== O(this).val();
    }).length,
        r = "multipart/form-data",
        c = E.attr("enctype") === r || E.attr("encoding") === r,
        n = v.fileapi && v.formdata;
    C("fileAPI :" + n);
    var l,
        r = (t || c) && !n;
    !1 !== F.iframe && (F.iframe || r) ? F.closeKeepAlive ? O.get(F.closeKeepAlive, function () {
      l = d(a);
    }) : l = d(a) : l = (t || c) && n ? function (e) {
    ...
    }(a) : O.ajax(F), E.removeData("jqxhr").data("jqxhr", l);
    ...
    function d(e) {
      var t,
          ...
          p = E[0],
          m = O.Deferred();
      if (m.abort = function (e) {
        l.abort(e);
      }, e) for (r = 0; r < M.length; r++) {
        t = O(M[r]), X ? t.prop("disabled", !1) : t.removeAttr("disabled");
      }
      (i = O.extend(!0, {}, O.ajaxSettings, F)).context = i.context || i, o = "jqFormIO" + new Date().getTime();
      var h = p.ownerDocument,
          v = E.closest("body");
      if (i.iframeTarget ? (a = (u = O(i.iframeTarget, h)).attr2("name")) ? o = a : u.attr2("name", o) : (u = O('<iframe name="' + o + '" src="' + i.iframeSrc + '" />', h)).css({
        position: "absolute",
        top: "-1000px",
        left: "-1000px"
      }), c = u[0], l = {
        ...
        abort: function abort(e) {
          ...
          u.attr("src", i.iframeSrc), l.error = t, i.error && i.error.call(i.context, l, t, e), s && O.event.trigger("ajaxError", [l, i, t]), i.complete && i.complete.call(i.context, l, t);
        }
      }, (s = i.global) && 0 == O.active++ && O.event.trigger("ajaxStart"), s && O.event.trigger("ajaxSend", [l, i]), i.beforeSend && !1 === i.beforeSend.call(i.context, l, i)) return i.global && O.active--, m.reject(), m;
      if (l.aborted) return m.reject(), m;
      (e = p.clk) && (a = e.name) && !e.disabled && (i.extraData = i.extraData || {}, i.extraData[a] = e.value, "image" === e.type && (i.extraData[a + ".x"] = p.clk_x, i.extraData[a + ".y"] = p.clk_y));
      var g = 1,
          x = 2;
      ...
      function n() {
        ...
        p.setAttribute("target", o), L && !/post/i.test(L) || p.setAttribute("method", "POST"), t !== i.url && p.setAttribute("action", i.url), i.skipEncodingOverride || L && !/post/i.test(L) || E.attr({
          encoding: "multipart/form-data",
          enctype: "multipart/form-data"
        }), i.timeout && (d = setTimeout(function () {
          f = !0, S(g);
        }, i.timeout));
        var a = [];

        try {
          if (i.extraData) for (var n in i.extraData) {
            i.extraData.hasOwnProperty(n) && (O.isPlainObject(i.extraData[n]) && i.extraData[n].hasOwnProperty("name") && i.extraData[n].hasOwnProperty("value") ? a.push(O('<input type="hidden" name="' + i.extraData[n].name + '">', h).val(i.extraData[n].value).appendTo(p)[0]) : a.push(O('<input type="hidden" name="' + n + '">', h).val(i.extraData[n]).appendTo(p)[0]));
          }
          i.iframeTarget || u.appendTo(v), c.attachEvent ? c.attachEvent("onload", S) : c.addEventListener("load", S, !1), setTimeout(function e() {
            try {
              var t = y(c).readyState;
              C("state = " + t), t && "uninitialized" === t.toLowerCase() && setTimeout(e, 50);
            } catch (e) {
              C("Server abort: ", e, " (", e.name, ")"), S(x), d && clearTimeout(d), d = void 0;
            }
          }, 15);
          ...
          p.setAttribute("action", t), p.setAttribute("enctype", r), e ? p.setAttribute("target", e) : E.removeAttr("target"), O(a).remove();
        }
      }

      a && e && (i.extraData = i.extraData || {}, i.extraData[a] = e), i.forceSync ? n() : setTimeout(n, 10);
      var b,
          T,
          j,
          w = 50;
      ...
      function S(e) {
        if (!l.aborted && !j) {
          if ((T = y(c)) || (C("cannot access response document"), e = x), e === g && l) return l.abort("timeout"), void m.reject(l, "timeout");
          if (e === x && l) return l.abort("server abort"), void m.reject(l, "error", "server abort");

          if (T && T.location.href !== i.iframeSrc || f) {
            c.detachEvent ? c.detachEvent("onload", S) : c.removeEventListener("load", S, !1);
            var t,
                r = "success";

            try {
              if (f) throw "timeout";
              var a = "xml" === i.dataType || T.XMLDocument || O.isXMLDoc(T);
              if (C("isXml=" + a), !a && window.opera && (null === T.body || !T.body.innerHTML) && --w) return C("requeing onLoad callback, DOM not available"), void setTimeout(S, 250);
              var n = T.body || T.documentElement;
              l.responseText = n ? n.innerHTML : null, l.responseXML = T.XMLDocument || T, a && (i.dataType = "xml"), l.getResponseHeader = function (e) {
                return {
                  "content-type": i.dataType
                }[e.toLowerCase()];
              }, n && (l.status = Number(n.getAttribute("status")) || l.status, l.statusText = n.getAttribute("statusText") || l.statusText);
              var o = (i.dataType || "").toLowerCase(),
                  a = /(json|script|text)/.test(o);
              a || i.textarea ? (n = T.getElementsByTagName("textarea")[0]) ? (l.responseText = n.value, l.status = Number(n.getAttribute("status")) || l.status, l.statusText = n.getAttribute("statusText") || l.statusText) : a && (n = T.getElementsByTagName("pre")[0], a = T.getElementsByTagName("body")[0], n ? l.responseText = n.textContent || n.innerText : a && (l.responseText = a.textContent || a.innerText)) : "xml" === o && !l.responseXML && l.responseText && (l.responseXML = k(l.responseText));

              try {
                b = A(l, o, i);
              } catch (e) {
                r = "parsererror", l.error = t = e || r;
              }
            } catch (e) {
              C("error caught: ", e), r = "error", l.error = t = e || r;
            }

            l.aborted && (C("upload aborted"), r = null), "success" === (r = l.status ? 200 <= l.status && l.status < 300 || 304 === l.status ? "success" : "error" : r) ? (i.success && i.success.call(i.context, b, "success", l), m.resolve(l.responseText, "success", l), s && O.event.trigger("ajaxSuccess", [l, i])) : r && (void 0 === t && (t = l.statusText), i.error && i.error.call(i.context, l, r, t), m.reject(l, "error", t), s && O.event.trigger("ajaxError", [l, i, t])), s && O.event.trigger("ajaxComplete", [l, i]), s && ! --O.active && O.event.trigger("ajaxStop"), i.complete && i.complete.call(i.context, l, r), j = !0, i.timeout && clearTimeout(d), setTimeout(function () {
              i.iframeTarget ? u.attr("src", i.iframeSrc) : u.remove(), l.responseXML = null;
            }, 100);
          }
        }
      }
    ...
    for (n = 0, u = (m = O.isFunction(r) ? O.map(m, r) : m).length; n < u; n++) {
      if ((f = (s = m[n]).name) && !s.disabled) if (e && d.clk && "image" === s.type) d.clk === s && (a.push({
        name: f,
        value: O(s).val(),
        type: s.type
      }), a.push({
        ...
        name: f + ".y",
        value: d.clk_y
      }));else if ((i = O.fieldValue(s, !0)) && i.constructor === Array) for (t && t.push(s), o = 0, c = i.length; o < c; o++) {
        a.push({
          name: f,
          value: i[o]
        });
        ...
        t && t.push(s);
        var h = s.files;
        if (h.length) for (o = 0; o < h.length; o++) {
          a.push({
            name: f,
            value: h[o],
            type: s.type
