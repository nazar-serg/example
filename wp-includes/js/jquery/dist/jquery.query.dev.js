  ...
  jQuery.query = new function () {
    ...
    j.prototype = {
      ...
      COMPACT: function COMPACT() {
        function l(o) {
          var n = _typeof(o) == "object" ? h(o, Array) ? [] : {} : o;

          if (_typeof(o) == "object") {
            var m = function m(r, p, q) {
              if (h(r, Array)) {
                r.push(q);
              } else {
                r[p] = q;
