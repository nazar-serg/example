...
!function (t) {
  ...
  x.cleanData = (c = x.cleanData, function (t) {
    ...
    for (var e, i, n = u.call(arguments, 1), o = 0, s = n.length; o < s; o++) {
      for (e in n[o]) {
        i = n[o][e], n[o].hasOwnProperty(e) && void 0 !== i && (x.isPlainObject(i) ? t[e] = x.isPlainObject(t[e]) ? x.widget.extend({}, t[e], i) : x.widget.extend({}, i) : t[e] = i);
      }
    }
    ...
    _classes: function _classes(o) {
      ...
      function t(t, e) {
        for (var i, n = 0; n < t.length; n++) {
          i = r.classesElementLookup[t[n]] || x(), i = o.add ? x(x.unique(i.get().concat(o.element.get()))) : x(i.not(o.element).get()), r.classesElementLookup[t[n]] = i, s.push(t[n]), e && o.classes[t[n]] && s.push(o.classes[t[n]]);
        }
      }
