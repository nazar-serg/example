...
!function (t) {
  ...
  return z.widget("ui.resizable", z.ui.mouse, {
    ...
    _destroy: function _destroy() {
      ...
      function t(t) {
        z(t).removeData("resizable").removeData("ui-resizable").off(".resizable").find(".ui-resizable-handle").remove();
      }
    ...
    _setOption: function _setOption(t, i) {
      this._super(t, i), "handles" === t && (this._removeHandles(), this._setupHandles());
    },
    _setupHandles: function _setupHandles() {
      ...
      if (this.handles = n.handles || (z(".ui-resizable-handle", this.element).length ? {
        ...
        ne: ".ui-resizable-ne",
        nw: ".ui-resizable-nw"
      } : "e,s,se"), this._handles = z(), this.handles.constructor === String) for ("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), e = this.handles.split(","), this.handles = {}, i = 0; i < e.length; i++) {
        s = "ui-resizable-" + (t = z.trim(e[i])), h = z("<div>"), this._addClass(h, "ui-resizable-handle " + s), h.css({
          zIndex: n.zIndex
        }), this.handles[t] = ".ui-resizable-" + t, this.element.append(h);
      }
    ...
    _mouseStart: function _mouseStart(t) {
      ...
      return this.resizing = !0, this._renderProxy(), i = this._num(this.helper.css("left")), e = this._num(this.helper.css("top")), s.containment && (i += z(s.containment).scrollLeft() || 0, e += z(s.containment).scrollTop() || 0), this.offset = this.helper.offset(), this.position = {
        ...
        left: t.pageX,
        top: t.pageY
      }, this.aspectRatio = "number" == typeof s.aspectRatio ? s.aspectRatio : this.originalSize.width / this.originalSize.height || 1, s = z(".ui-resizable-" + this.axis).css("cursor"), z("body").css("cursor", "auto" === s ? this.axis + "-resize" : s), this._addClass("ui-resizable-resizing"), this._propagate("start", t), !0;
    },
    _mouseDrag: function _mouseDrag(t) {
      var i = this.originalMousePosition,
          ...
          i = t.pageY - i.top || 0,
          e = this._change[e];
      return this._updatePrevProperties(), e && (i = e.apply(this, [t, s, i]), this._updateVirtualBoundaries(t.shiftKey), (this._aspectRatio || t.shiftKey) && (i = this._updateRatio(i, t)), i = this._respectSize(i, t), this._updateCache(i), this._propagate("resize", t), i = this._applyChanges(), !this._helper && this._proportionallyResizeElements.length && this._proportionallyResize(), z.isEmptyObject(i) || (this._updatePrevProperties(), this._trigger("resize", t, this.ui()), this._applyChanges())), !1;
    },
    _mouseStop: function _mouseStop(t) {
      ...
      var i,
          ...
          h = this.options,
          n = this;
      return this._helper && (s = (i = (e = this._proportionallyResizeElements).length && /textarea/i.test(e[0].nodeName)) && this._hasScroll(e[0], "left") ? 0 : n.sizeDiff.height, e = i ? 0 : n.sizeDiff.width, i = {
    ...
    _updateVirtualBoundaries: function _updateVirtualBoundaries(t) {
      ...
      (this._aspectRatio || t) && (i = h.minHeight * this.aspectRatio, e = h.minWidth / this.aspectRatio, s = h.maxHeight * this.aspectRatio, t = h.maxWidth / this.aspectRatio, i > h.minWidth && (h.minWidth = i), e > h.minHeight && (h.minHeight = e), s < h.maxWidth && (h.maxWidth = s), t < h.maxHeight && (h.maxHeight = t)), this._vBoundaries = h;
    },
    ...
    _renderProxy: function _renderProxy() {
      var t = this.element,
          i = this.options;
      this.elementOffset = t.offset(), this._helper ? (this.helper = this.helper || z("<div style='overflow:hidden;'></div>"), this._addClass(this.helper, this._helper), this.helper.css({
        width: this.element.outerWidth(),
        height: this.element.outerHeight(),
        position: "absolute",
    ...
    stop: function stop(i) {
      var e = z(this).resizable("instance"),
        ...
        height: e.size.height - n
          ...
          o = parseFloat(e.element.css("left")) + (e.position.left - e.originalPosition.left) || null,
          n = parseFloat(e.element.css("top")) + (e.position.top - e.originalPosition.top) || null;
      e.element.animate(z.extend(h, n && o ? {
        top: n,
        left: o
      } : {}), {
    ...
    start: function start() {
      var e,
          ...
          i = h.element,
          n = t.containment,
          o = n instanceof z ? n.get(0) : /parent/.test(n) ? i.parent().get(0) : n;
      ...
      }, t = h.containerOffset, i = h.containerSize.height, n = h.containerSize.width, n = h._hasScroll(o, "left") ? o.scrollWidth : n, i = h._hasScroll(o) ? o.scrollHeight : i, h.parentData = {
        element: o,
        left: t.left,
        top: t.top,
        width: n,
