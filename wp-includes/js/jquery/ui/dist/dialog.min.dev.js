...
!function (i) {
  ...
  return l.widget("ui.dialog", {
    ...
    _focusTabbable: function _focusTabbable() {
      ...
      (i = !(i = !(i = !(i = !(i = i || this.element.find("[autofocus]")).length ? this.element.find(":tabbable") : i).length ? this.uiDialogButtonPane.find(":tabbable") : i).length ? this.uiDialogTitlebarClose.filter(":tabbable") : i).length ? this.uiDialog : i).eq(0).trigger("focus");
    },
    ...
    _createWrapper: function _createWrapper() {
      this.uiDialog = l("<div>").hide().attr({
        ...
        keydown: function keydown(i) {
          ...
          var t, e, o;
          i.keyCode !== l.ui.keyCode.TAB || i.isDefaultPrevented() || (t = this.uiDialog.find(":tabbable"), e = t.filter(":first"), o = t.filter(":last"), i.target !== o[0] && i.target !== this.uiDialog[0] || i.shiftKey ? i.target !== e[0] && i.target !== this.uiDialog[0] || !i.shiftKey || (this._delay(function () {
            o.trigger("focus");
    ...
    _createButtons: function _createButtons() {
      ...
      this.uiDialogButtonPane.remove(), this.uiButtonSet.empty(), l.isEmptyObject(i) || l.isArray(i) && !i.length ? this._removeClass(this.uiDialog, "ui-dialog-buttons") : (l.each(i, function (i, t) {
        var e;
        t = l.isFunction(t) ? {
          click: t,
          text: i
    ...
    _createOverlay: function _createOverlay() {
      ...
      }), this.overlay = l("<div>").appendTo(this._appendTo()), this._addClass(this.overlay, null, "ui-widget-overlay ui-front"), this._on(this.overlay, {
        mousedown: "_keepFocus"
      }), this.document.data("ui-dialog-overlays", (this.document.data("ui-dialog-overlays") || 0) + 1));
    },
    _destroyOverlay: function _destroyOverlay() {
      var i;
      this.options.modal && this.overlay && ((i = this.document.data("ui-dialog-overlays") - 1) ? this.document.data("ui-dialog-overlays", i) : (this._off(this.document, "focusin"), this.document.removeData("ui-dialog-overlays")), this.overlay.remove(), this.overlay = null);
    }
