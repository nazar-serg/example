...
!function (e) {
  ...
  return u.widget("ui.selectmenu", [u.ui.formResetMixin, {
    ...
    _move: function _move(e, t) {
      var i,
          n = ".ui-menu-item";
      this.isOpen ? i = this.menuItems.eq(this.focusIndex).parent("li") : (i = this.menuItems.eq(this.element[0].selectedIndex).parent("li"), n += ":not(.ui-state-disabled)"), (n = "first" === e || "last" === e ? i["first" === e ? "prevAll" : "nextAll"](n).eq(-1) : i[e + "All"](n).eq(0)).length && this.menuInstance.focus(t, n);
    },
    ...
    _documentClick: {
      mousedown: function mousedown(e) {
        this.isOpen && (u(e.target).closest(".ui-selectmenu-menu, #" + u.ui.escapeSelector(this.ids.button)).length || this.close(e));
      }
    },
    _buttonEvents: {
    ...
    _appendTo: function _appendTo() {
      ...
      return e = !(e = !(e = e && (e.jquery || e.nodeType ? u(e) : this.document.find(e).eq(0))) || !e[0] ? this.element.closest(".ui-front, dialog") : e).length ? this.document[0].body : e;
    },
