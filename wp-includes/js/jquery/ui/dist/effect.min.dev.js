...
!function (t) {
  ...
  function T(t, e, n, r) {
    ...
    }, null == e && (e = {}), u.isFunction(e) && (r = e, n = null, e = {}), "number" != typeof e && !u.fx.speeds[e] || (r = n, n = e, e = {}), u.isFunction(n) && (r = n, n = null), e && u.extend(t, e), n = n || e.duration, t.duration = u.fx.off ? 0 : "number" == typeof n ? n : n in u.fx.speeds ? u.fx.speeds[n] : u.fx.speeds._default, t.complete = r || e.complete, t;
  }

  function F(t) {
    return !t || "number" == typeof t || u.fx.speeds[t] || "string" == typeof t && !u.effects.effect[t] || u.isFunction(t) || "object" == _typeof(t) && !t.effect;
  }
  ...
  p = /^([\-+])=\s*(\d+\.?\d*)/, t = [{
    ...
    transition: function transition(t, s) {
      ...
      return b(n.props, function (t, e) {
        var n = e.idx,
            ...
            i = f[n],
            o = m[e.type] || {};
        null !== i && (null === r ? c[n] = i : (o.mod && (o.mod / 2 < i - r ? r += o.mod : o.mod / 2 < r - i && (r -= o.mod)), c[n] = M((i - r) * s + r, e)));
      }), this[e](c);
    },
  ...
  }), h.fn.parse.prototype = h.fn, g.hsla.to = function (t) {
        ...
        set: function set(t, e) {
          ...
          if ("transparent" !== e && ("string" !== l.type(e) || (n = B(e)))) {
            if (e = h(n || e), !s.rgba && 1 !== e._rgba[3]) {
              for (r = "backgroundColor" === o ? t.parentNode : t; ("" === i || "transparent" === i) && r && r.style;) {
                try {
    ...
    return this.queue(function () {
      ...
      r(), e = e.map(function () {
        return this.end = I(this.el[0]), this.diff = function (t, e) {
          ...
          for (n in e) {
            r = e[n], t[n] !== r && (v[n] || !u.fx.step[n] && isNaN(parseFloat(r)) || (i[n] = r));
          }
    ...
    switchClass: function switchClass(t, e, n, r, i) {
    ...
    setTransition: function setTransition(r, t, i, o) {
