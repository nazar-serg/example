...
!function (V) {
  ...
  var e,
    ...
    return B.call(e);
      ...
      re = function re(e, t) {
    return function (e, t) {
      for (var n = t !== undefined && null !== t ? t : ne, r = 0; r < e.length && n !== undefined && null !== n; ++r) {
        n = n[e[r]];
      }
  ...
  var le,
    ...
    y.bind = function (e, t, n, r) {
      ...
      if (e && 3 !== e.nodeType && 8 !== e.nodeType) {
        for (e[g] ? o = e[g] : (o = m++, e[g] = o, b[o] = {}), r = r || e, a = (t = t.split(" ")).length; a--;) {
          c = d, s = l = !1, "DOMContentLoaded" === (u = t[a]) && (u = "ready"), y.domLoaded && "ready" === u && "complete" === e.readyState ? n.call(r, Ne({
            type: u
  ...
  var Te,
    ...
    return e === t && (Le = !0), 0;
      ...
      Qe = typeof undefined === "undefined" ? "undefined" : _typeof(undefined),
      Ze = {}.hasOwnProperty,
      et = [],
      tt = et.pop,
      nt = et.push,
    ...
    if (Ue && !r) {
      ...
      if (ke.qsa && (!je || !je.test(e))) {
        if (f = l = qe, d = t, m = 9 === u && e, 1 === u && "object" !== t.nodeName.toLowerCase()) {
          for (c = De(e), (l = t.getAttribute("id")) ? f = l.replace(wt, "\\$&") : t.setAttribute("id", f), f = "[id='" + f + "'] ", s = c.length; s--;) {
            c[s] = f + Pt(c[s]);
          }
  ...
  function Ot(e) {
    return e && _typeof(e.getElementsByTagName) !== Qe && e;
  }
  ...
  for (Te in ke = St.support = {}, Re = St.isXML = function (e) {
    ...
    return s !== Me && 9 === s.nodeType && s.documentElement ? (ze = (Me = s).documentElement, Ue = !Re(s), n && n !== function (e) {
      ...
      if (_typeof(t.getElementById) !== Qe && Ue) {
      ...
      if (_typeof(t.getElementsByTagName) !== Qe) return t.getElementsByTagName(e);
    } : function (e, t) {
      var n,
          r = [],
          o = 0,
    ...
    filter: {
      ...
      CLASS: function CLASS(e) {
        ...
        return t || (t = new RegExp("(^|" + at + ")" + e + "(" + at + "|$)")) && Xe(e, function (e) {
          return t.test("string" == typeof e.className && e.className || _typeof(e.getAttribute) !== Qe && e.getAttribute("class") || "");
        });
      },
  ...
  function Mt(m, g, p, h, v, e) {
    return h && !h[qe] && (h = Mt(h)), v && !v[qe] && (v = Mt(v, e)), kt(function (e, t, n, r) {
      ...
      if (p && p(f, d, n, r), h) for (o = Ft(d, s), h(o, [], n, r), i = o.length; i--;) {
        (a = o[i]) && (d[s[i]] = !(f[s[i]] = a));
      }
  ...
  function zt(e) {
    for (var r, t, n, o = e.length, i = _e.relative[e[0].type], a = i || _e.relative[" "], u = i ? 1 : 0, s = It(function (e) {
      ...
      if (t = _e.relative[e[u].type]) l = [It(Lt(l), t)];else {
  ...
  Bt.prototype = _e.filters = _e.pseudos, _e.setFilters = new Bt(), De = St.tokenize = function (e, t) {
    ...
    for (a = e, u = [], s = _e.preFilter; a;) {
      for (i in n && !(r = ft.exec(a)) || (r && (a = a.slice(r[0].length) || a), u.push(o = [])), n = !1, (r = dt.exec(a)) && (n = r.shift(), o.push({
        value: n,
        type: r[0].replace(lt, " ")
      }), a = a.slice(n.length)), _e.filter) {
        !(r = ht[i].exec(a)) || s[i] && !(r = s[i](r)) || (n = r.shift(), o.push({
          value: n,
          type: i,
          matches: r
        }), a = a.slice(n.length));
    ...
    if (!a) {
      ...
      (a = Ge(e, (h = i, y = 0 < (v = o).length, b = 0 < h.length, r = function r(e, t, n, _r2, o) {
        var i,
            a,
            u,
            s = 0,
        ...
        if (s += c, y && c !== s) {
          ...
          if (e) {
            if (0 < s) for (; c--;) {
              l[c] || f[c] || (f[c] = tt.call(_r2));
            }
            f = Ft(f);
          }

          rt.apply(_r2, f), o && !e && 0 < f.length && 1 < s + v.length && St.uniqueSort(_r2);
        }
  ...
  var Ut = Array.isArray,
    ...
    toArray: function toArray(e) {
      var t,
          n,
          r = e;
      if (!Ut(e)) for (r = [], t = 0, n = e.length; t < n; t++) {
        r[t] = e[t];
      }
      return r;
    },
    ...
    return null === e || e === undefined ? "" : ("" + e).replace(qt, "");
      ...
      Wt = function Wt(e, t) {
    return t ? !("array" !== t || !Ht.isArray(e)) || _typeof(e) === t : e !== undefined;
  },
    ...
    for (o = (t = t || Yt).createElement("div"), n = t.createDocumentFragment(), o.innerHTML = e; r = o.firstChild;) {
      n.appendChild(r);
    }
    ...
    if (nn(t)) t = rn(t, bn(e[0]));else if (t.length && !t.nodeType) {
      if (t = gn.makeArray(t), r) for (o = t.length - 1; 0 <= o; o--) {
        on(e, t[o], n, r);
  ...
  gn.fn = gn.prototype = {
    ...
    init: function init(e, t) {
      ...
      if (nn(e)) {
        ...
        if (n[1]) for (r = rn(e, bn(t)).firstChild; r;) {
    ...
    add: function add(e, t) {
      ...
      if (!1 !== t) for (n = gn.unique(o.toArray().concat(gn.makeArray(e))), o.length = n.length, r = 0; r < n.length; r++) {
        o[r] = n[r];
    ...
    attr: function attr(t, n) {
      var e,
          r = this;
      if ("object" == _typeof(t)) vn(t, function (e, t) {
        r.attr(e, t);
      });else {
        if (!tn(n)) {
    ...
    prop: function prop(e, t) {
      var n = this;
      if ("object" == _typeof(e = ln[e] || e)) vn(e, function (e, t) {
        n.prop(e, t);
      });else {
    ...
    css: function css(n, r) {
      ...
      if ("object" == _typeof(n)) vn(n, function (e, t) {
        i.css(e, t);
    ...
    trigger: function trigger(e) {
      return this.each(function () {
        "object" == _typeof(e) ? Zt.fire(this, e.type, e) : Zt.fire(this, e);
      });
    },
    show: function show() {
  ...
  kn = undefined, _n = eo, An = to, Rn = undefined, function (e) {
    "object" == _typeof(_n) && void 0 !== An ? An.exports = e() : "function" == typeof kn && kn.amd ? kn([], e) : ("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this).EphoxContactWrapper = e();
  }(function () {
  ...
  var Jo = function Jo(e, t) {
    ...
    if (e) {
      for (e = e.split(","), t = t || 10, n = 0; n < e.length; n += 2) {
        r = String.fromCharCode(parseInt(e[n], t)), ho[r] || (o = "&" + e[n + 1] + ";", i[r] = o, i[o] = r);
      }
  ...
  var Qo = function Qo(e, t) {
    ...
    var u,
      ...
      for (t = t || "", "string" == typeof (n = n || []) && (n = ci(n)), r = (e = ci(e)).length; r--;) {
        i = {
  ...
  function di(i) {
    ...
    var S = function S(e) {
      ...
      var t,
          ...
          x = /^([!\-])?(\w+[\\:]:\w+|[^=:<]+)?(?:([=:<])(.*))?$/,
          w = /[*?+]/;
      if (e) for (e = ci(e, ","), N["@"] && (h = N["@"].attributes, v = N["@"].attributesOrder), t = 0, n = e.length; t < n; t++) {
        if (i = C.exec(e[t])) {
          ...
          if (s) for (r = 0, o = (s = ci(s, "|")).length; r < o; r++) {
            if (i = x.exec(s[r])) {
  ...
  function gi(b, e) {
    ...
    for (b = b || {}, e && (c = e.getValidStyles(), l = e.getInvalidStyles()), t = ("\\\" \\' \\; \\: ; : " + T).split(" "), C = 0; C < t.length; C++) {
      S[t[C]] = T + C, S[T + C] = t[C];
    }
    ...
    var r = {},
      ...
      var y = function y(e) {
        ...
        return uo.nu(function (e) {
          n(_t2, H(e, q(mo.value(_t2))), H(e, q(mo.error(_t2))));
        });
      },
          o = function o(e) {
        return e.fold($, $);
  ...
  var ea,
    ...
    e.on("init", function () {
      ...
      _ma = function ma() {
    return (_ma = Object.assign || function (e) {
  ...
  var Tu,
    ...
    for (jo.isText(a) ? s.push(n ? function (e, t, n) {
      ...
      for (o = e(t.data.slice(0, n)).length, r = t.previousSibling; r && jo.isText(r); r = r.previousSibling) {
        o += e(r.data).length;
      }
    ...
    var t,
      ...
      !function (e) {
        ...
        for (t = gn("*[contentEditable=false]", e), o = 0; o < t.length; o++) {
          r = (n = t[o]).previousSibling, Ba(r) && (1 === (i = r.data).length ? r.parentNode.removeChild(r) : r.deleteData(i.length - 1, 1)), r = n.nextSibling, Oa(r) && (1 === (i = r.data).length ? r.parentNode.removeChild(r) : r.deleteData(0, 1));
        }
  ...
  var Ms,
    ...
    moveStart: function moveStart(e, t, n) {
      var r,
          ...
          a = n.startOffset,
          u = n.startContainer;
      if ((n.startContainer !== n.endContainer || !bc(n.startContainer.childNodes[n.startOffset])) && 1 === u.nodeType) for (a < (i = u.childNodes).length ? r = new go(u = i[a], e.getParent(u, e.isBlock)) : (r = new go(u = i[i.length - 1], e.getParent(u, e.isBlock))).next(!0), o = r.current(); o; o = r.next()) {
  ...
  var qc = function qc(e) {
    ...
    this.compare = function (e, t) {
      ...
      var n = function n(_n4) {
        var r = {};
        return Zc(o.getAttribs(_n4), function (e) {
          var t = e.nodeName.toLowerCase();
  ...
  var ul,
    ...
    if (/^ | $/.test(t) && (t = function (e, t) {
      ...
      if (e._selectionOverrides.showBlockCaretContainer(i), k.invalid) {
        for (fl(e, d), i = g.getNode(), a = e.getBody(), 9 === i.nodeType ? i = f = a : f = i; f !== a;) {
          f = (i = f).parentNode;
        }
    ...
    return Hl(ar.fromDom(e), ar.fromDom(n.getNode())).map(function (e) {
      ...
      Hf = function Hf(u, s, c) {
    return sc.fromPosition(s, u, c).bind(function (e) {
      return a = e.getNode(), _o(ar.fromDom(a)) || So(ar.fromDom(a)) ? _.none() : (t = u, o = e, i = function i(e) {
    ...
    var n,
        ...
        a = Hr(e).filter(mr),
        u = qr(e).filter(mr);
    return Ui(e), (n = a, r = u, o = t, i = function i(e, t, n) {
      var r,
          o,
          i,
          a,
    ...
    return 0 < function (e) {
      ...
      qm = function qm(e) {
    var t;
    if (e) for (e = (t = new go(e, e)).current(); e; e = t.next()) {
    ...
    var r = e.dom,
        o = e.selection;
    if (t) Wm(e, t, n);else if (!(t = Qu(e.getBody(), o.getStart()))) for (; t = r.get(Vm);) {
      Wm(e, t, !1);
    }
  },
  ...
  var hp = Xt.makeMap("focus blur focusin focusout click dblclick mousedown mouseup mousemove mouseover beforepaste paste cut copy selectionchange mouseout mouseenter mouseleave wheel keydown keypress keyup input contextmenu dragstart dragend dragover draggesture dragdrop drop drag submit compositionstart compositionend compositionupdate touchstart touchmove touchend", " "),
    ...
    var r = function r(e, t, n, _r3) {
      ...
      if (!1 === t && (t = f), t) for (t = {
        func: t
      }, _r3 && Xt.extend(t, _r3), a = (i = e.toLowerCase().split(" ")).length; a--;) {
  ...
  var yp,
    ...
    fire: function fire(e, t, n) {
      ...
      if (t = bp(this).fire(e, t, n), !1 !== n && this.parent) for (var r = this.parent(); r && !t.isPropagationStopped();) {
  ...
  var iv = function iv(o, i, a, e, u, t) {
    var n,
        s,
        c = 0,
        l = [],
    ...
    return Ht.reduce(e, function (e, t) {
      ...
      hv = function hv(e, t, n, r) {
    for (; r = fv(r, e, $a, t);) {
      if (n(r)) return;
    }
  },
      vv = function vv(e, t, n) {
    var r,
        o,
        i,
        a,
    ...
    return (r = pv(f, t)) && (r = pv((a = e, c = function c(t, e) {
      var n;
            ...
            if (!p || (l = U.getElementRule(n))) {
              if (f = !0, p && (y = l.attributes, b = l.attributePatterns), (v = t[8]) ? ((m = -1 !== v.indexOf("data-mce-type")) && u && (f = !1), (d = []).map = {}, v.replace(T, F)) : (d = []).map = {}, p && !m) {
                if (C = l.attributesRequired, x = l.attributesDefault, w = l.attributesForced, l.removeEmptyAttrs && !d.length && (f = !1), w) for (o = w.length; o--;) {
                  a = (h = w[o]).name, "{$uid}" === (_ = h.value) && (_ = "mce_" + O++), d.map[a] = _, d.push({
                    name: a,
                    value: _
                  });
                }
                if (x) for (o = x.length; o--;) {
                  (a = (h = x[o]).name) in d.map || ("{$uid}" === (_ = h.value) && (_ = "mce_" + O++), d.map[a] = _, d.push({
                    name: a,
                    value: _
                  }));
                }
  ...
  var Mv = Fv,
    ...
    for (u = e.getTempAttrs(), s = l, c = new RegExp(["\\s?(" + u.join("|") + ')="[^"]+"'].join("|"), "gi"), l = s.replace(c, ""), a = d.getShortEndedElements(); i = f.exec(l);) {
      r = f.lastIndex, o = i[0].length, n = a[i[1]] ? r : Mv.findEndTag(d, l, r), l = l.substring(0, r - o) + l.substring(n), f.lastIndex = r - o;
    }
    ...
    var r = function (e) {
      ...
      for (r = V.document.createElement("div"), t = V.document.createDocumentFragment(), e && (r.innerHTML = e); n = r.firstChild;) {
        t.appendChild(n);
      }
  ...
  function Gy(e) {
    ...
    })(jy.get(t.dom)), _r5(t.settings.formats), {
      get: function get(e) {
        return e ? n[e] : n;
      },
      register: _r5,
  ...
  var Jy,
    ...
    register: function register(t, s, c) {
      t.addAttributeFilter("data-mce-tabindex", function (e, t) {
        ...
        for (var r, o = e.length; o--;) {
          "bookmark" !== (r = e[o]).attributes.map["data-mce-type"] || n.cleanup || (_.from(r.firstChild).exists(function (e) {
            return !Ca(e.value);
          }) ? r.unwrap() : r.remove());
        }
    ...
    return a.create = function (e, t) {
      var n, r;
      if (n = new a(e, ab[e] || 1), t) for (r in t) {
        n.attr(r, t[r]);
      }
      return n;
      ...
      if (this.firstChild) {
        for (e = [], n = this.firstChild; n; n = ub(n, this)) {
          e.push(n);
        }
    ...
    p.remove_trailing_brs && e.addNodeFilter("br", function (e, t, n) {
      ...
      if (!p.allow_unsafe_link_target) for (; o--;) {
        "a" === (t = e[o]).name && "_blank" === t.attr("target") && t.attr("rel", (n = t.attr("rel"), r = n ? Xt.trim(n) : "", /\b(noopener)\b/g.test(r) ? r : r.split(" ").filter(function (e) {
          return 0 < e.length;
  ...
  function bb(T, k) {
    ...
    var O = function O(e) {
      ...
      for (; t--;) {
        (n = A[t].name) in e.attributes.map && ((r = D[n]) ? r.push(e) : D[n] = [e]);
      }
        ...
        t = Mv({
          ...
          start: function start(e, t, n) {
            ...
            if (i = h ? k.getElementRule(e) : {}) {
              for ((r = N(i.outputName || e, 1)).attributes = t, r.shortEnded = n, d.append(r), (u = p[d.name]) && p[r.name] && !u[r.name] && m.push(r), o = A.length; o--;) {
            ...
            if (n = h ? k.getElementRule(e) : {}) {
              if (l[e] && !f) {
                if ((t = d.firstChild) && 3 === t.type) if (0 < (r = t.value.replace(b, "")).length) t.value = r, t = t.next;else for (o = t.next, t.remove(), t = o; t && 3 === t.type;) {
        ...
        if (t.parse(e), h && m.length && (a.context ? a.invalid = !0 : function (e) {
          ...
          for (d = pb("tr,td,th,tbody,thead,tfoot,table"), l = k.getNonEmptyElements(), f = k.getWhiteSpaceElements(), m = k.getTextBlockElements(), g = k.getSpecialElements(), t = 0; t < e.length; t++) {
            if ((n = e[t]).parent && !n.fixed) if (m[n.name] && "li" === n.parent.name) {
              ...
              for (o = [n], r = n.parent; r && !k.isValidChild(r.name, n.name) && !d[r.name]; r = r.parent) {
                o.push(r);
              }

              if (r && 1 < o.length) {
                for (o.reverse(), i = a = O(o[0].clone()), c = 0; c < o.length - 1; c++) {
                  for (k.isValidChild(a.name, o[c].name) ? (u = O(o[c].clone()), a.append(u)) : u = a, s = o[c].firstChild; s && s !== o[c + 1];) {
          ...
          if (k.isValidChild(S.name, v.toLowerCase())) {
            for (; n;) {
              e = n.next, 3 === n.type || 1 === n.type && "p" !== n.name && !l[n.name] && !n.attr("data-mce-type") ? (t || ((t = N(v, 1)).attr(T.forced_root_block_attrs), S.insert(t, n)), t.append(n)) : (r(t), t = null), n = e;
            }
  ...
  var Tb,
    ...
    if (u.no_events || !(u = e.fire("BeforeSetContent", u)).isDefaultPrevented()) {
      if (t = function (e, t) {
        if ("raw" !== t.format) {
          var n = e.parser.parse(t.content, _ma({
            isRootContent: !0,
            forced_root_block: !1
          }, t));
          return al({
      ...
      getSelectedBlocks: function getSelectedBlocks(e, t) {
        return function (e, t, n, r) {
          var o,
              i,
              a = [];
          if (i = e.getRoot(), n = e.getParent(n || tC(i, t, t.collapsed), e.isBlock), r = e.getParent(r || nC(i, t, t.collapsed), e.isBlock), n && n !== i && a.push(n), n && r && n !== r) for (var u = new go(o = n, i); (o = u.next()) && o !== r;) {
    ...
    Dg(x, E).each(function (e) {
      ...
      if (!(a = m.getParent(r, m.isBlock)) || !lx(m, a)) {
        ...
        if (u && e.schema.isValidChild(l, d.toLowerCase())) {
          for (i = m.create(d), gx(e, i), u.parentNode.insertBefore(i, u), s = u; s && !m.isBlock(s);) {
  ...
  var gw = function gw(e) {
    ...
    f.inline || (t.getElement().style.visibility = t.orgVisibility), e || f.content_editable || (m.open(), m.write(t.iframeHTML), m.close()), f.content_editable && (t.on("remove", function () {
      ...
      for (var t, n = e.length, r = u.schema.getNonEmptyElements(); n--;) {
        (t = e[n]).isEmpty(r) && 0 === t.getAll("br").length && (t.append(new sb("br", 1)).shortEnded = !0);
      }
  ...
  jN.extend = _N2 = function _N(n) {
    var e,
        ...
        i = function i() {
      var e, t, n;
      if (!AN && (this.init && this.init.apply(this, arguments), t = this.Mixins)) for (e = t.length; e--;) {
    ...
    for (t in AN = !0, e = new this(), AN = !1, n.Mixins && (zN(n.Mixins, function (e) {
      ...
      i[t] = e;
    }), n.Defaults && o.Defaults && (n.Defaults = UN({}, o.Defaults, n.Defaults)), n) {
      "function" == typeof (r = n[t]) && o[t] ? e[t] = u(t, r) : e[t] = r;
    }

    return i.prototype = e, (i.constructor = i).extend = _N2, i;
  };
  ...
  var VN = Math.min,
    ...
    if ("object" === t) {
      ...
      for (i in o = "{", e) {
        e.hasOwnProperty(i) && (o += "function" != typeof e[i] ? (1 < o.length ? "," + n : n) + i + n + ":" + $N(e[i], n) : "");
      }
