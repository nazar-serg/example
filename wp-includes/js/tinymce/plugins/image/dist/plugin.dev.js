...
(function () {
  var image = function (domGlobals) {
    ...
    var updateVSpaceHSpaceBorder = function updateVSpaceHSpaceBorder(editor) {
      return function (evt) {
        var dom = editor.dom;
    ...
    var updateStyle = function updateStyle(editor, win) {
    ...
    var makeTab = function makeTab(editor) {
      return {
        title: 'Advanced',
        type: 'form',
        pack: 'start',
    ...
    var createUi = function createUi() {
      var recalcSize = function recalcSize(evt) {
    ...
    var onSrcChange = function onSrcChange(evt, editor) {
    ...
    var onBeforeCall = function onBeforeCall(evt) {
      evt.meta = evt.control.rootControl.toJSON();
    };

    var getGeneralItems = function getGeneralItems(editor, imageListCtrl) {
    ...
    var makeTab$1 = function makeTab$1(editor, imageListCtrl) {
      return {
        title: 'General',
        type: 'form',
    ...
    var onFileInput = function onFileInput(editor) {
      return function (evt) {
    ...
    var makeTab$2 = function makeTab$2(editor) {
      return {
        title: 'Upload',
        type: 'form',
        layout: 'flex',
    ...
    var submitForm = function submitForm(editor, evt) {
