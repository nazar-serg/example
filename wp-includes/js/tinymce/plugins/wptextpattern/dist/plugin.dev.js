  ...
  tinymce.PluginManager.add('wptextpattern', function (editor) {
    ...
    editor.on('keydown', function (event) {
      ...
      if (event.keyCode === VK.ENTER) {
        enter(); // Wait for the browser to insert the character.
    ...
    function inline() {
      ...
      var pattern;
      var format;
      var zero; // We need a non-empty text node with an offset greater than zero.
      ...
      tinymce.each(inlinePatterns, function (p) {
        ...
        var after = string.charAt(startOffset + p.delimiter.length); // test*test*  => format applied.
        // test *test* => applied.
