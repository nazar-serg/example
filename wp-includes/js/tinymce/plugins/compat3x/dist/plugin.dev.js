...
(function (tinymce) {
  ...
  function Dispatcher(target, newEventName, argsMap, defaultScope) {
    ...
    this.add = function (callback, scope, prepend) {
      log('<target>.on' + newEventName + ".add(..)"); // Convert callback({arg1:x, arg2:x}) -> callback(arg1, arg2)
  ...
  function patchEditor(editor) {
    ...
    editor.controlManager = {
      buttons: {},
      setDisabled: function setDisabled(name, state) {
      ...
      setActive: function setActive(name, state) {
