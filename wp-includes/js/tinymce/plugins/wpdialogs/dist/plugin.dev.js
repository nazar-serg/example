...
tinymce.WPWindowManager = tinymce.InlineWindowManager = function (editor) {
  ...
  this.open = function (args, params) {
    ...
    wp.features = args;
    wp.params = params; // Store selection. Takes a snapshot in the FocusManager of the selection before focus is moved to the dialog.

    editor.nodeChanged(); // Create the dialog if necessary.
