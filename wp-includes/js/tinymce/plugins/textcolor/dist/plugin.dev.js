...
(function () {
  var textcolor = function () {
    ...
    var getTextColorMap = function getTextColorMap(editor) {
      return editor.getParam('textcolor_map', defaultColorMap);
    };

    var getForeColorMap = function getForeColorMap(editor) {
      return editor.getParam('forecolor_map', getTextColorMap(editor));
    };

    var getBackColorMap = function getBackColorMap(editor) {
      return editor.getParam('backcolor_map', getTextColorMap(editor));
    };

    var getTextColorRows = function getTextColorRows(editor) {
      return editor.getParam('textcolor_rows', 5);
    };

    var getTextColorCols = function getTextColorCols(editor) {
      return editor.getParam('textcolor_cols', 8);
    };

    var getForeColorRows = function getForeColorRows(editor) {
      return editor.getParam('forecolor_rows', getTextColorRows(editor));
    };

    var getBackColorRows = function getBackColorRows(editor) {
      return editor.getParam('backcolor_rows', getTextColorRows(editor));
    };

    var getForeColorCols = function getForeColorCols(editor) {
      return editor.getParam('forecolor_cols', getTextColorCols(editor));
    };

    var getBackColorCols = function getBackColorCols(editor) {
    ...
    var hasColorPicker = function hasColorPicker(editor) {
    ...
    var getHtml = function getHtml(cols, rows, colorMap, hasColorPicker) {
      var colors,
          color,
          html,
          last,
      ...
      var getColorCellHtml = function getColorCellHtml(color, title) {
    ...
    var onButtonClick = function onButtonClick(editor) {
      return function (e) {
        var ctrl = e.control;
    ...
    var onPanelClick = function onPanelClick(editor, cols) {
      return function (e) {
        var buttonCtrl = this.parent();
        var value;
        var currentColor = TextColor.getCurrentColor(editor, buttonCtrl.settings.format);

        var selectColor = function selectColor(value) {
    ...
    var renderColorPicker = function renderColorPicker(editor, foreColor) {
      return function () {
