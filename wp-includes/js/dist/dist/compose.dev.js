...
/******/
{
  ...
  function _(module, __webpack_exports__, __webpack_require__) {
    ...
    var external_this_lodash_ = __webpack_require__(2); // CONCATENATED MODULE: ./node_modules/@wordpress/compose/build-module/utils/create-higher-order-component/index.js
    ...
    var create_higher_order_component = createHigherOrderComponent; // CONCATENATED MODULE: ./node_modules/@wordpress/compose/build-module/higher-order/compose.js
    ...
    var compose = external_this_lodash_["flowRight"]; // EXTERNAL MODULE: external {"this":["wp","element"]}

    var external_this_wp_element_ = __webpack_require__(0); // CONCATENATED MODULE: ./node_modules/@wordpress/compose/build-module/higher-order/if-condition/index.js
    ...
    var if_condition = if_condition_ifCondition; // EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/classCallCheck.js
    ...
    var getPrototypeOf = __webpack_require__(19); // EXTERNAL MODULE: external {"this":["wp","isShallowEqual"]}
    ...
    /*#__PURE__*/
    __webpack_require__.n(external_this_wp_isShallowEqual_); // CONCATENATED MODULE: ./node_modules/@wordpress/compose/build-module/higher-order/pure/index.js
    ...
    var higher_order_pure = pure; // EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/extends.js

    var esm_extends = __webpack_require__(8); // EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/assertThisInitialized.js


    var assertThisInitialized = __webpack_require__(16); // CONCATENATED MODULE: ./node_modules/@wordpress/compose/build-module/higher-order/with-global-events/listener.js
    ...
    var listener = listener_Listener; // CONCATENATED MODULE: ./node_modules/@wordpress/compose/build-module/higher-order/with-global-events/index.js

    function with_global_events_createSuper(Derived) {
      var hasNativeReflectConstruct = with_global_events_isNativeReflectConstruct();
      return function _createSuperInternal() {
        var Super = Object(getPrototypeOf["a"
        /* default */
        ])(Derived),
    ...
    function with_global_events_isNativeReflectConstruct() {
      if (typeof Reflect === "undefined" || !Reflect.construct) return false;
      if (Reflect.construct.sham) return false;
      if (typeof Proxy === "function") return true;
      ...
      return create_higher_order_component(function (WrappedComponent) {
        ...
        function (_Component) {
          ...
          function Wrapper() {
            ...
            _this.handleEvent = _this.handleEvent.bind(Object(assertThisInitialized["a"
            /* default */
            ])(_this));
            _this.handleRef = _this.handleRef.bind(Object(assertThisInitialized["a"
            /* default */
            ])(_this));
            return _this;
          }
    ...
    var with_global_events = withGlobalEvents; // CONCATENATED MODULE: ./node_modules/@wordpress/compose/build-module/hooks/use-instance-id/index.js
    ...
    }, 'withInstanceId'); // CONCATENATED MODULE: ./node_modules/@wordpress/compose/build-module/higher-order/with-safe-timeout/index.js

    function with_safe_timeout_createSuper(Derived) {
      var hasNativeReflectConstruct = with_safe_timeout_isNativeReflectConstruct();
      return function _createSuperInternal() {
        var Super = Object(getPrototypeOf["a"
        /* default */
        ])(Derived),
    ...
    function with_safe_timeout_isNativeReflectConstruct() {
      if (typeof Reflect === "undefined" || !Reflect.construct) return false;
      if (Reflect.construct.sham) return false;
      if (typeof Proxy === "function") return true;
      ...
      return (
        ...
        function (_Component) {
          ...
          function WrappedComponent() {
            ...
            _this = _super.apply(this, arguments);
            _this.timeouts = [];
            _this.setTimeout = _this.setTimeout.bind(Object(assertThisInitialized["a"
            /* default */
            ])(_this));
            _this.clearTimeout = _this.clearTimeout.bind(Object(assertThisInitialized["a"
            /* default */
            ])(_this));
            return _this;
          }
    ...
    var with_safe_timeout = withSafeTimeout; // CONCATENATED MODULE: ./node_modules/@wordpress/compose/build-module/higher-order/with-state/index.js

    function with_state_createSuper(Derived) {
      var hasNativeReflectConstruct = with_state_isNativeReflectConstruct();
      return function _createSuperInternal() {
        var Super = Object(getPrototypeOf["a"
        /* default */
        ])(Derived),
    ...
    function with_state_isNativeReflectConstruct() {
      if (typeof Reflect === "undefined" || !Reflect.construct) return false;
      if (Reflect.construct.sham) return false;
      if (typeof Proxy === "function") return true;
        ...
        return (
          ...
          function (_Component) {
            ...
            function WrappedComponent() {
              ...
              _this = _super.apply(this, arguments);
              _this.setState = _this.setState.bind(Object(assertThisInitialized["a"
              /* default */
              ])(_this));
    ...
    var slicedToArray = __webpack_require__(12); // EXTERNAL MODULE: ./node_modules/clipboard/dist/clipboard.js
    ...
    /*#__PURE__*/
    __webpack_require__.n(dist_clipboard); // CONCATENATED MODULE: ./node_modules/@wordpress/compose/build-module/hooks/use-copy-on-click/index.js
      ...
      Object(external_this_wp_element_["useEffect"])(function () {
        ...
        clipboard.current.on('success', function (_ref) {
          var clearSelection = _ref.clearSelection,
              trigger = _ref.trigger; // Clearing selection will move focus back to the triggering button,
    ...
    /*#__PURE__*/
    __webpack_require__.n(mousetrap_mousetrap); // EXTERNAL MODULE: ./node_modules/mousetrap/plugins/global-bind/mousetrap-global-bind.js


    var mousetrap_global_bind = __webpack_require__(442); // CONCATENATED MODULE: ./node_modules/@wordpress/compose/build-module/hooks/use-keyboard-shortcut/index.js
    ...
    var use_keyboard_shortcut = useKeyboardShortcut; // CONCATENATED MODULE: ./node_modules/@wordpress/compose/build-module/hooks/use-media-query/index.js
    ...
    var use_reduced_motion = useReducedMotion; // CONCATENATED MODULE: ./node_modules/@wordpress/compose/build-module/hooks/use-viewport-match/index.js
    ...
    var use_viewport_match = use_viewport_match_useViewportMatch; // EXTERNAL MODULE: ./node_modules/react-resize-aware/dist/index.js

    var dist = __webpack_require__(151);

    var dist_default =
    /*#__PURE__*/
    __webpack_require__.n(dist); // CONCATENATED MODULE: ./node_modules/@wordpress/compose/build-module/hooks/use-resize-observer/index.js
    ...
    var use_resize_observer = dist_default.a; // EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/toConsumableArray.js + 2 modules

    var toConsumableArray = __webpack_require__(17); // EXTERNAL MODULE: external {"this":["wp","priorityQueue"]}


    var external_this_wp_priorityQueue_ = __webpack_require__(152); // CONCATENATED MODULE: ./node_modules/@wordpress/compose/build-module/hooks/use-async-list/index.js
    ...
    var use_async_list = useAsyncList; // CONCATENATED MODULE: ./node_modules/@wordpress/compose/build-module/hooks/use-warn-on-change/index.js
    ...
    var use_warn_on_change = useWarnOnChange; // EXTERNAL MODULE: ./node_modules/use-memo-one/dist/use-memo-one.esm.js

    var use_memo_one_esm = __webpack_require__(153); // CONCATENATED MODULE: ./node_modules/@wordpress/compose/build-module/hooks/use-debounce/index.js
    ...
    function useDebounce() {
      ...
      var debounced = Object(use_memo_one_esm["a"
      /* useMemoOne */
      ])(function () {
