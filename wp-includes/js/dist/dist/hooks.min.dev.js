...
(void 0).wp = (void 0).wp || {}, (void 0).wp.hooks = function (n) {
  var r = {};
  ...
  return e.m = n, e.c = r, e.d = function (n, r, t) {
    ...
    if (4 & r && "object" == _typeof(n) && n && n.__esModule) return n;
    var t = Object.create(null);
    if (e.r(t), Object.defineProperty(t, "default", {
      enumerable: !0,
      value: n
    }), 2 & r && "string" != typeof n) for (var o in n) {
      e.d(t, o, function (r) {
        return n[r];
      }.bind(null, o));
    }
  ...
  481: function _(n, r, e) {
    ...
    var i = function i(n) {
      return function (r, e, i) {
        ...
        if (o(r) && t(e)) if ("function" == typeof i) {
          if ("number" == typeof u) {
            var c = {
              callback: i,
              priority: u,
      ...
      return function (e, i) {
        if (o(e) && (r || t(i))) {
          ...
          if (r) u = n[e].handlers.length, n[e] = {
            runs: n[e].runs,
            handlers: []
          };else for (var c = n[e].handlers, a = function a(r) {
