...
(void 0).wp = (void 0).wp || {}, (void 0).wp.richText = function (e) {
  var t = {};
  ...
  471: function _(e, t, r) {
    "use strict";

    r.r(t), r.d(t, "applyFormat", function () {
      return P;
    ...
    var l = Object(o.combineReducers)({
      formatTypes: function formatTypes() {
    ...
    Object(o.registerStore)("core/rich-text", {
      reducer: l,
      selectors: n,
      actions: a
    });
    ...
    function P(e, t) {
      ...
      if (r === n) {
        ...
        if (u) {
          for (var s = i[r].indexOf(u); i[r] && i[r][s] === u;) {
            i[r] = E(i[r], s, t), r--;
          }
      ...
      return w(T(T({}, e), {}, {
        formats: i,
        activeFormats: [].concat(Object(h.a)(Object(c.reject)(o, {
          type: t.type
        })), [t])
      }));
    }
    ...
    function D(e, t) {
      ...
      return D.body || (D.body = r.createHTMLDocument("").body), D.body.innerHTML = t, D.body;
    }
    ...
    function N() {
      ...
      return "string" == typeof r && r.length > 0 ? {
        ...
        text: r
      } : ("string" == typeof n && n.length > 0 && (t = D(document, n)), "object" !== Object(_.a)(t) ? {
        formats: [],
        replacements: [],
        text: ""
      } : o ? W({
    ...
    function R(e) {
      ...
      for (var f = t.childNodes.length, p = function p(e) {
        ...
        if (a && -1 !== a.indexOf(f)) {
          var y = W({
            ...
            currentWrapperTags: [].concat(Object(h.a)(c), [g]),
            isEditableTree: u,
            preserveWhiteSpace: s
          });
          return I(l, i, r, y), H(l, y), "continue";
        }
        ...
        if (I(l, i, r, j), g) {
          if (0 === j.text.length) g.attributes && H(l, {
            formats: [,],
            replacements: [g],
            text: "￼"
          });else {
            var _w = function _w(e) {
              if (_w.formats === e) return _w.newFormats;
              var t = e ? [g].concat(Object(h.a)(e)) : [g];
              return _w.formats = e, _w.newFormats = t, t;
            };

            _w.newFormats = [g], H(l, C(C({}, j), {}, {
              formats: Array.from(j.formats, _w)
            }));
          }
        } else H(l, j);
      }, d = 0; d < f; d++) {
    ...
    function q(e) {
      var t = e.replacements[G(e, e.start)];
      return !t || t.length < 1;
    }

    function X(e, t, r) {
      var n = e.replacements[G(e, e.start)];
    ...
    function Z(e) {
      var t = e.text,
          r = e.start,
          n = e.end;
      return r === n && (0 === t.length || 0 === r && t.slice(0, 1) === S || r === t.length && t.slice(-1) === S || t.slice(r - 1, n + 1) === "".concat(S).concat(S));
    }
    ...
    function ee(e, t) {
      if ("string" == typeof (t = function (e) {
        ...
        if (/^[a-z][a-z0-9-]*\/[a-z][a-z0-9-]*$/.test(t.name)) {
          if (Object(o.select)("core/rich-text").getFormatType(t.name)) window.console.error('Format "' + t.name + '" is already registered.');else if ("string" == typeof t.tagName && "" !== t.tagName) {
            if ("string" == typeof t.className && "" !== t.className || null === t.className) {
              if (/^[_a-zA-Z]+[a-zA-Z0-9-]*$/.test(t.className)) {
                if (null === t.className) {
                  var r = Object(o.select)("core/rich-text").getFormatTypeForBareElement(t.tagName);
                  ...
                  var n = Object(o.select)("core/rich-text").getFormatTypeForClassName(t.className);
                ...
                if ("title" in t && "" !== t.title) {
                  if ("keywords" in t && t.keywords.length > 3) window.console.error('The format "' + t.name + '" can have a maximum of 3 keywords.');else {
                    if ("string" == typeof t.title) return Object(o.dispatch)("core/rich-text").addFormatTypes(t), t;
    ...
    function ne(e, t) {
      ...
      if (r === n) {
        ...
        if (u) {
          for (; Object(c.find)(i[r], u);) {
            ae(i, r, t), r--;
          }

          for (n++; Object(c.find)(i[n], u);) {
            ae(i, n, t), n++;
          }
        }
      } else for (var s = r; s < n; s++) {
        i[s] && ae(i, s, t);
      }
    ...
    function fe(e) {
      ...
      if (t || (c = o, u = a, s = i ? o + 1 : o), n[c] === S) {
        var l;

        if (i && r[c] && r[c].length) {
          var f = r.slice();
          f[c] = r[c].slice(0, -1), l = le(le({}, e), {}, {
            replacements: f
          });
        } else l = ie(e, u, s);
    ...
    function ve(e, t) {
      var r = e.formats,
          ...
          o = e.start,
          i = e.end;
      if ("string" != typeof t) return ge.apply(void 0, arguments);
      var c = 0;
    ...
    function ye(e) {
      var t = e.type,
          ...
          i = e.boundaryClass,
          c = function (e) {
        return Object(o.select)("core/rich-text").getFormatType(e);
      }(t),
          u = {};

      if (i && (u["data-rich-text-format-boundary"] = "true"), !c) return r && (u = Oe(Oe({}, r), u)), {
        type: t,
        attributes: u,
        object: a
      };

      for (var s in u = Oe(Oe({}, n), u), r) {
    ...
    function je(e) {
      ...
      for (var C = function C(e) {
        var a = w.charAt(e),
            c = g && (!n || n === S || "\n" === n),
            E = y[e];
        o && (E = a === S ? t = (j[e] || []).reduce(function (e, t) {
          return e.push(t, _), e;
        }, [_]) : [].concat(Object(h.a)(t), Object(h.a)(E || [])));
        var D = s(P);
        ...
        if (n === S) {
          ...
          m && x === e && m(P, A), v && T === e && v(P, A);
        }

        if (E && E.forEach(function (e, t) {
          if (D && r && function (e, t, r) {
            do {
              if (e[r] !== t[r]) return !1;
            } while (r--);

            return !0;
          }(E, r, t) && (a !== S || E.length - 1 !== t)) D = s(D);else {
            var n = e.type,
                o = e.attributes,
            ...
            f(D) && 0 === p(D).length && d(D), D = u(m, "");
          }
        }), a === S) return r = E, n = a, "continue";
        0 === e && (m && 0 === x && m(P, D), v && 0 === T && v(P, D)), "￼" === a ? (D = u(l(D), ye(Oe(Oe({}, j[e]), {}, {
          object: !0
        }))), D = u(l(D), "")) : i || "\n" !== a ? f(D) ? b(D, a) : D = u(l(D), a) : (D = u(l(D), {
          type: "br",
          attributes: g ? {
            "data-rich-text-line-break": "true"
          } : void 0,
          object: !0
        }), D = u(l(D), "")), m && x === e + 1 && m(P, D), v && T === e + 1 && v(P, D), c && e === w.length && (u(l(D), "\uFEFF"), O && 0 === w.length && u(l(D), {
          type: "span",
          attributes: {
    ...
    function Te(e, t, r) {
      for (var n = e.parentNode, a = 0; e = e.previousSibling;) {
        a++;
      }

      return r = [a].concat(Object(h.a)(r)), n !== t && (r = Te(n, t, r)), r;
    }

    function Ee(e, t) {
      for (t = Object(h.a)(t); e && t.length > 1;) {
    ...
    function Pe(e, t) {
      ...
      var r = t,
          n = r.type,
          a = r.attributes;
      if (n) for (var o in t = e.ownerDocument.createElement(n), a) {
    ...
    function Ne(e) {
      ...
      return {
        body: je({
          ...
          remove: Ae,
          appendText: _e,
          onStartIndex: function onStartIndex(e, t) {
            s = Te(t, e, [t.nodeValue.length]);
          },
          onEndIndex: function onEndIndex(e, t) {
            l = Te(t, e, [t.nodeValue.length]);
          },
          isEditableTree: o,
          placeholder: i
        }),
    ...
    function Ie(e) {
      ...
      !function e(t, r) {
        ...
        for (; n = t.firstChild;) {
          ...
          if (o) {
            if (o.isEqualNode(n)) t.removeChild(n);else if (o.nodeName !== n.nodeName || o.nodeType === o.TEXT_NODE && o.data !== n.data) r.replaceChild(n, o);else {
              var i = o.attributes,
                  c = n.attributes;
              if (i) for (var u = i.length; u--;) {
                var s = i[u].name;
        ...
        var b = l.activeElement;

        if (p.rangeCount > 0) {
          if (m = d, v = p.getRangeAt(0), m.startContainer === v.startContainer && m.startOffset === v.startOffset && m.endContainer === v.endContainer && m.endOffset === v.endOffset) return;
          p.removeAllRanges();
        }

        var m, v;
        p.addRange(d), b !== l.activeElement && b instanceof f.HTMLElement && b.focus();
      }(u, r);
    }
    ...
    function Ue(e) {
      ...
      for (var i in r) {
        Object(ke.isValidAttributeName)(i) && (o += " ".concat(i, '="').concat(Object(ke.escapeAttribute)(r[i]), '"'));
      }

      return n ? "<".concat(t).concat(o, ">") : "<".concat(t).concat(o, ">").concat(Ge(a), "</").concat(t, ">");
    }

    function Ge() {
      var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [];
      return e.map(function (e) {
        return void 0 === e.text ? Ue(e) : Object(ke.escapeEditableHTML)(e.text);
      }).join("");
    }

    function qe(e, t) {
      return B(e, t.type) ? ne(e, t.type) : P(e, t);
    }

    function Xe(e) {
      var t = Object(o.select)("core/rich-text").getFormatType(e);
      if (t) return Object(o.dispatch)("core/rich-text").removeFormatTypes(e), t;
    ...
    function $e(e) {
      return void 0 !== e.replacements[G(e, e.start)];
    }
    ...
    function Qe(e, t) {
      ...
      for (var r = G(e), n = G(e, r), a = e.text, o = e.replacements, i = e.end, c = o.slice(), u = function (e, t) {
    ...
    function et(e, t) {
      for (var r = e.text, n = e.replacements, a = n[t] || [], o = t; o-- >= 0;) {
        if (r[o] === S) if ((n[o] || []).length === a.length - 1) return o;
      }
    }
    ...
    function nt(e) {
      ...
      for (var t = e.text, r = e.replacements, n = e.start, a = e.end, o = G(e, n), i = r.slice(0), c = r[et(e, o)] || [], u = function (e, t) {
    ...
    function it(e, t) {
      for (var r, n = e.text, a = e.replacements, o = e.start, i = e.end, c = G(e, o), u = a[c] || [], s = a[G(e, i)] || [], l = et(e, c), f = a.slice(), p = u.length - 1, d = s.length - 1, b = l + 1 || 0; b < n.length; b++) {
        if (n[b] === S) {
    ...
    var ct = r(12),
        ...
        lt = r(36),
        ft = r.n(lt),
        pt = new Set(["a", "audio", "button", "details", "embed", "iframe", "input", "label", "select", "textarea", "video"]);
    ...
    function dt(e) {
      var t = e.formatTypes,
          ...
          a = e.value,
          o = e.allowedFormats,
          i = e.withoutInteractiveFormatting;
      return t.map(function (e) {
        var t = e.name,
            c = e.edit,
            u = e.tagName;
        if (!c) return null;
        if (o && -1 === o.indexOf(t)) return null;
        if (i && pt.has(u)) return null;
        var s = B(a, t),
            l = void 0 !== s,
            f = z(a),
            p = void 0 !== f && f.type === t;
        return Object(ut.createElement)(c, {
          key: t,
          isActive: l,
          activeAttributes: l && s.attributes || {},
          isObjectActive: p,
          activeObjectAttributes: p && f.attributes || {},
          value: a,
          onChange: r,
          onFocus: n
        });
    ...
    function vt(e) {
      return e("core/rich-text").getFormatTypes();
    }
    ...
    var Ot = new Set(["insertParagraph", "insertOrderedList", "insertUnorderedList", "insertHorizontalRule", "insertLink"]),
        yt = {
      whiteSpace: "pre-wrap"
    },
        jt = [];
    ...
    var xt = Object(ut.forwardRef)(function (e, t) {
      var r = e.tagName,
          n = void 0 === r ? "div" : r,
          a = e.value,
          i = void 0 === a ? "" : a,
          ...
          l = e.children,
          f = e.allowedFormats,
          p = e.withoutInteractiveFormatting,
          d = e.placeholder,
          b = e.disabled,
          ...
          x = e.onChange,
          T = e.unstableOnFocus,
          E = e.setFocusedElement,
          P = e.instanceId,
          _ = e.clientId,
          D = e.identifier,
          F = e.__unstableMultilineTag,
          C = e.__unstableMultilineRootTag,
          A = e.__unstableDisableFormats,
          I = e.__unstableDidAutomaticChange,
          k = e.__unstableInputRule,
          L = e.__unstableMarkAutomaticChange,
          R = e.__unstableAllowPrefixTransformations,
          W = e.__unstableUndo,
          M = e.__unstableIsCaretWithinFormattedText,
          H = e.__unstableOnEnterFormattedText,
          V = e.__unstableOnExitFormattedText,
          B = e.__unstableOnCreateUndoLevel,
          z = e.__unstableIsSelected,
        ...
        var t = e.clientId,
            r = e.identifier,
            n = Object(o.useSelect)(vt, []),
            a = Object(o.useSelect)(function (e) {
        ...
        return n.forEach(function (e) {
          if (e.__experimentalCreatePrepareEditableTree) {
            var n = a[e.name],
                o = e.__experimentalCreatePrepareEditableTree(n, {
              richTextIdentifier: r,
              blockClientId: t
            });

            for (var f in e.__experimentalCreateOnChangeEditableValue ? u.push(o) : c.push(o), n) {
              l.push(n[f]);
            }
          }
          ...
          if (e.__experimentalCreateOnChangeEditableValue) {
            var p = {};
            e.__experimentalGetPropsForEditableTreeChangeHandler && (p = e.__experimentalGetPropsForEditableTreeChangeHandler(i, {
              richTextIdentifier: r,
              blockClientId: t
            })), s.push(e.__experimentalCreateOnChangeEditableValue(mt(mt({}, a[e.name] || {}), p), {
              richTextIdentifier: r,
              blockClientId: t
            }));
          }
        ...
        identifier: D
          ...
          Q = J.formatTypes,
          ee = J.prepareHandlers,
          te = J.valueHandlers,
          re = J.changeHandlers,
          ae = J.dependencies;

      function ce() {
        return t.current.ownerDocument;
      }

      function ue() {
        return ce().defaultView;
      }
      ...
      function se(e) {
        ...
        if ("string" !== h) return e;
        var t = wt(te),
            r = N({
          html: e,
          multilineTag: F,
          multilineWrapperTags: "li" === F ? ["ul", "ol"] : void 0,
      ...
      function le(e) {
        return Q.forEach(function (t) {
          t.__experimentalCreatePrepareEditableTree && (e = ne(e, t.name, 0, e.text.length));
        }), e;
      }

      function pe(e) {
        return A ? e.text : (e = le(e), "string" === h ? Le({
          value: e,
          multilineTag: F,
          preserveWhiteSpace: m
        }) : void 0);
      ...
      C || "string" != typeof n || (C = n);
      var de = Object(ut.useRef)(i),
          be = Object(ut.useRef)(Object(ut.useMemo)(function () {
        var e = se(i);
        return e.start = u, e.end = s, e;
      }, []));

      function me() {
        var e = ue().getSelection(),
            r = e.rangeCount > 0 ? e.getRangeAt(0) : null;
        return N({
          element: t.current,
          range: r,
          multilineTag: F,
      ...
      function ve(e) {
        ...
        Ie({
          ...
          multilineTag: F,
          multilineWrapperTags: "li" === F ? ["ul", "ol"] : void 0,
          prepareEditableTree: wt(ee),
          __unstableDomOnly: n,
          placeholder: d
        });
      }

      var ge = Object(ut.useRef)(i);

      function he() {
        ge.current !== de.current && (B(), ge.current = de.current);
      }
      ...
      function je(e) {
        var t;
        if (!Oe.current) if (e && (t = e.inputType), !t && e && e.nativeEvent && (t = e.nativeEvent.inputType), !t || 0 !== t.indexOf("format") && !Ot.has(t)) {
          var r = me(),
              n = be.current,
              a = n.start,
              o = n.activeFormats,
            ...
            for (t.activeFormats = a.map(function (e, t) {
              if (o[t]) {
                if (O(e, o[t])) return o[t];
              } else if (i[t] && O(e, i[t])) return i[t];

              return e;
            }); --n >= r;) {
              t.activeFormats.length > 0 ? t.formats[n] = t.activeFormats : delete t.formats[n];
            }
          ...
          if (Te(c, {
            withoutHistory: !0
          }), ue().clearTimeout(ye.current), ye.current = ue().setTimeout(he, 1e3), "insertText" === t) {
            R && k && k(c, pe);
            var u = Q.reduce(function (e, t) {
      ...
      var we = Object(ut.useRef)(!1);

      function xe(e) {
        if (t.current && t.current.ownerDocument.activeElement === t.current && ("selectionchange" === e.type || z) && !b && !Oe.current) {
          var r = me(),
              n = r.start,
              a = r.end,
              o = r.text,
            ...
            if (n !== i.start || a !== i.end) {
              var c = ht(ht({}, i), {}, {
                ...
                activeFormats: void 0
                  ...
                  u = K(c, jt);
              c.activeFormats = u, !M && u.length ? H() : M && !u.length && V(), be.current = c, ve(c, {
                domOnly: !0
              }), w(n, a), $(u);
            } else 0 === i.text.length && 0 === n && function (e) {
      ...
      function Te(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
            r = t.withoutHistory;
        A && (e.formats = Array(e.text.length), e.replacements = Array(e.text.length)), ve(e);
        var n = e.start,
            a = e.end,
            o = e.activeFormats,
            i = void 0 === o ? [] : o;
        Object.values(re).forEach(function (t) {
          t(e.formats, e.text);
        }), de.current = pe(e), be.current = e, w(n, a), x(de.current), $(i), r || he();
      }

      function Ee(e) {
        var r = e.target;

        if (r !== t.current && !r.textContent) {
          var n = r.parentNode,
              a = Array.from(n.childNodes).indexOf(r),
              o = ce().createRange(),
              i = ue().getSelection();
          o.setStart(r.parentNode, a), o.setEnd(r.parentNode, a + 1), i.removeAllRanges(), i.addRange(o);
        }
      }

      var Pe = Object(ut.useRef)();

      function _e() {
        de.current = i, be.current = se(i), be.current.start = u, be.current.end = s, ve(be.current);
      }

      function De() {
        t.current.focus(), ve(be.current);
      }

      Object(ut.useEffect)(function () {
        we.current && _e();
      }, [n, d]), Object(ut.useEffect)(function () {
        we.current && i !== de.current && _e();
      }, [i]), Object(ut.useEffect)(function () {
        we.current && (!z || u === be.current.start && s === be.current.end ? be.current = ht(ht({}, be.current), {}, {
          start: u,
          end: s
        }) : _e());
      }, [u, s, z]), Object(ut.useEffect)(function () {
        we.current && _e();
      }, ae), Object(ut.useLayoutEffect)(function () {
        return ve(be.current, {
          domOnly: !0
        }), we.current = !0, function () {
          ce().removeEventListener("selectionchange", xe), ue().cancelAnimationFrame(Pe.current), ue().clearTimeout(ye.current);
        };
      }, []);
      var Se = {
        role: "textbox",
        ...
        onPaste: function onPaste(e) {
          if (z) {
            var t = e.clipboardData,
                r = t.items,
                n = t.files;
            r = Object(c.isNil)(r) ? [] : r, n = Object(c.isNil)(n) ? [] : n;
            var a = "",
                o = "";

            try {
              a = t.getData("text/plain"), o = t.getData("text/html");
            } catch (e) {
              try {
                o = t.getData("Text");
              } catch (e) {
            ...
            if (e.preventDefault(), window.console.log("Received HTML:\n\n", o), window.console.log("Received plain text:\n\n", a), A) Te(oe(be.current, a));else {
              var i = Q.reduce(function (e, t) {
                var r = t.__unstablePasteRule;
                return r && e === be.current && (e = r(be.current, {
                  html: o,
                  plainText: a
                })), e;
              }, be.current);
              i === be.current ? v && (n = Array.from(n), Array.from(r).forEach(function (e) {
                if (e.getAsFile) {
                  var t = e.getAsFile();
        ...
        onCompositionStart: function onCompositionStart() {
          Oe.current = !0, ce().removeEventListener("selectionchange", xe);
        },
        onCompositionEnd: function onCompositionEnd() {
          Oe.current = !1, je({
            inputType: "insertText"
          }), ce().addEventListener("selectionchange", xe);
        },
        onKeyDown: function onKeyDown(e) {
          e.defaultPrevented || (function (e) {
            var t = e.keyCode;

            if (t === st.DELETE || t === st.BACKSPACE || t === st.ESCAPE) {
              if (I) return e.preventDefault(), void W();
              ...
              if (t !== st.ESCAPE) {
                var r,
                    ...
                    i = n.text,
                    c = t === st.BACKSPACE;
                if (0 === a && 0 !== o && o === i.length) return Te(ie(n)), void e.preventDefault();
                if (F) if (r = c && 0 === n.start && 0 === n.end && Z(n) ? fe(n, !c) : fe(n, c)) return Te(r), void e.preventDefault();
                !y || !Y(n) || X.length || c && 0 !== a || !c && o !== i.length || (y({
                  isReverse: c,
                  value: n
                }), e.preventDefault());
              }
            ...
            e.keyCode === st.ENTER && (e.preventDefault(), j && j({
              value: le(me()),
              onChange: Te,
              shiftKey: e.shiftKey
            }));
            ...
            if (!(n || a || o || i || r !== st.LEFT && r !== st.RIGHT)) {
              var c = be.current,
                  u = c.text,
                  s = c.formats,
                  l = c.start,
                  ...
                  d = void 0 === p ? [] : p,
                  b = Y(be.current),
                  m = "rtl" === ue().getComputedStyle(t.current).direction ? st.RIGHT : st.LEFT,
                  v = e.keyCode === m;

              if (b && 0 === d.length) {
                if (0 === l && v) return;
                if (f === u.length && !v) return;
              }
              ...
              if (b) {
                ...
                if (g.length > h.length && (y = g), g.length < h.length ? (!v && d.length < h.length && O++, v && d.length > g.length && O--) : g.length > h.length && (!v && d.length > h.length && O--, v && d.length < g.length && O++), O !== d.length) {
                  var j = y.slice(0, O),
                      x = ht(ht({}, be.current), {}, {
                    activeFormats: j
                  });
                  return be.current = x, ve(x), void $(j);
                }
                ...
                be.current = P, ve(P), w(T, T), $(E);
              }
            }
          }(e));
        },
        onFocus: function onFocus() {
          if (T && T(), z) w(be.current.start, be.current.end), $(K(ht(ht({}, be.current), {}, {
            activeFormats: void 0
          }), jt));else {
            be.current = ht(ht({}, be.current), {}, {
              start: void 0,
              end: void 0,
              activeFormats: jt
            }), w(void 0, void 0), $(jt);
          }
          Pe.current = ue().requestAnimationFrame(xe), ce().addEventListener("selectionchange", xe), E && (ft()("wp.blockEditor.RichText setFocusedElement prop", {
            alternative: "selection state from the block editor store."
          }), E(P));
        },
        onBlur: function onBlur() {
          ce().removeEventListener("selectionchange", xe);
        },
        onMouseDown: Ee,
        onTouchStart: Ee,
        onKeyUp: xe,
      ...
      return function (e) {
        ...
        e.ref, Object(ut.useEffect)(function () {}, []);
      }({
        ref: t
      }), Object(ut.createElement)(ut.Fragment, null, z && Object(ut.createElement)(dt, {
        allowedFormats: f,
        withoutInteractiveFormatting: p,
        value: be.current,
        onChange: Te,
        onFocus: De,
        formatTypes: Q
        ...
        editableProps: Se,
        editableTagName: n
      }), !l && Object(ut.createElement)(n, Se));
    });
  },
  5: function _(e, t, r) {
    "use strict";
