...
(void 0).wp = (void 0).wp || {}, (void 0).wp.keycodes = function (t) {
  var n = {};
  ...
  return r.m = t, r.c = n, r.d = function (t, n, e) {
    ...
    if (r.r(e), Object.defineProperty(e, "default", {
      enumerable: !0,
      value: t
    }), 2 & n && "string" != typeof t) for (var u in t) {
      r.d(e, u, function (n) {
        return t[n];
      }.bind(null, u));
    }
  ...
  498: function _(t, n, r) {
    ...
    var a = 8,
      ...
      shiftAlt: function shiftAlt() {
        ...
        C = Object(o.mapValues)(w, function (t) {
      return function (n) {
        var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : i;
        return [].concat(Object(u.a)(t(r)), [n.toLowerCase()]).join("+");
      };
    }),
        E = Object(o.mapValues)(w, function (t) {
      return function (n) {
        var r,
            c = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : i,
            a = c(),
            f = (r = {}, Object(e.a)(r, m, a ? "⌥" : "Alt"), Object(e.a)(r, h, a ? "⌃" : "Ctrl"), Object(e.a)(r, g, "⌘"), Object(e.a)(r, S, a ? "⇧" : "Shift"), r),
      ...
      return function (n) {
        ...
        _ = Object(o.mapValues)(w, function (t) {
      return function (n) {
        var r,
            a = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : i,
            f = a(),
            l = (r = {}, Object(e.a)(r, S, "Shift"), Object(e.a)(r, g, f ? "Command" : "Control"), Object(e.a)(r, h, "Control"), Object(e.a)(r, m, f ? "Option" : "Alt"), Object(e.a)(r, ",", Object(c.__)("Comma")), Object(e.a)(r, ".", Object(c.__)("Period")), Object(e.a)(r, "`", Object(c.__)("Backtick")), r);
    ...
    function T(t) {
      return [m, h, g, S].filter(function (n) {
        return t["".concat(n, "Key")];
      });
    }

    var x = Object(o.mapValues)(w, function (t) {
      return function (n, r) {
