...
/******/
{
  ...
  function _(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.r(__webpack_exports__); // EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/defineProperty.js
    ...
    var objectWithoutProperties = __webpack_require__(14); // EXTERNAL MODULE: external {"this":["wp","i18n"]}


    var external_this_wp_i18n_ = __webpack_require__(1); // CONCATENATED MODULE: ./node_modules/@wordpress/api-fetch/build-module/middlewares/nonce.js
    ...
    var nonce = createNonceMiddleware; // CONCATENATED MODULE: ./node_modules/@wordpress/api-fetch/build-module/middlewares/namespace-endpoint.js

    function namespace_endpoint_ownKeys(object, enumerableOnly) {
      var keys = Object.keys(object);
    ...
    function namespace_endpoint_objectSpread(target) {
      for (var i = 1; i < arguments.length; i++) {
        var source = arguments[i] != null ? arguments[i] : {};

        if (i % 2) {
          namespace_endpoint_ownKeys(Object(source), true).forEach(function (key) {
            Object(defineProperty["a"
            /* default */
            ])(target, key, source[key]);
          });
          ...
          namespace_endpoint_ownKeys(Object(source)).forEach(function (key) {
            Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
          });
        }
      }
    ...
    var namespace_endpoint = namespaceAndEndpointMiddleware; // CONCATENATED MODULE: ./node_modules/@wordpress/api-fetch/build-module/middlewares/root-url.js

    function root_url_ownKeys(object, enumerableOnly) {
      var keys = Object.keys(object);
    ...
    function root_url_objectSpread(target) {
      for (var i = 1; i < arguments.length; i++) {
        var source = arguments[i] != null ? arguments[i] : {};

        if (i % 2) {
          root_url_ownKeys(Object(source), true).forEach(function (key) {
            Object(defineProperty["a"
            /* default */
            ])(target, key, source[key]);
          });
          ...
          root_url_ownKeys(Object(source)).forEach(function (key) {
            Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
          });
        }
      }
    ...
    var root_url = root_url_createRootURLMiddleware; // CONCATENATED MODULE: ./node_modules/@wordpress/api-fetch/build-module/middlewares/preloading.js
    ...
    var preloading = createPreloadingMiddleware; // EXTERNAL MODULE: external {"this":"regeneratorRuntime"}
    ...
    var asyncToGenerator = __webpack_require__(45); // EXTERNAL MODULE: external {"this":["wp","url"]}


    var external_this_wp_url_ = __webpack_require__(30); // CONCATENATED MODULE: ./node_modules/@wordpress/api-fetch/build-module/middlewares/fetch-all-middleware.js


    function fetch_all_middleware_ownKeys(object, enumerableOnly) {
      var keys = Object.keys(object);
    ...
    function fetch_all_middleware_objectSpread(target) {
      for (var i = 1; i < arguments.length; i++) {
        ...
        if (i % 2) {
          fetch_all_middleware_ownKeys(Object(source), true).forEach(function (key) {
            Object(defineProperty["a"
            /* default */
            ])(target, key, source[key]);
          });
          ...
          fetch_all_middleware_ownKeys(Object(source)).forEach(function (key) {
            Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
          });
        }
      }
    ...
    var fetch_all_middleware_modifyQuery = function modifyQuery(_ref, queryArgs) {
      var path = _ref.path,
          url = _ref.url,
          options = Object(objectWithoutProperties["a"
      /* default */
      ])(_ref, ["path", "url"]);
    ...
    var fetch_all_middleware = fetchAllMiddleware; // CONCATENATED MODULE: ./node_modules/@wordpress/api-fetch/build-module/middlewares/http-v1.js

    function http_v1_ownKeys(object, enumerableOnly) {
      var keys = Object.keys(object);
    ...
    function http_v1_objectSpread(target) {
      for (var i = 1; i < arguments.length; i++) {
        var source = arguments[i] != null ? arguments[i] : {};

        if (i % 2) {
          http_v1_ownKeys(Object(source), true).forEach(function (key) {
            Object(defineProperty["a"
            /* default */
            ])(target, key, source[key]);
          });
          ...
          http_v1_ownKeys(Object(source)).forEach(function (key) {
            Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
          });
        }
      }
    ...
    var http_v1 = httpV1Middleware; // CONCATENATED MODULE: ./node_modules/@wordpress/api-fetch/build-module/middlewares/user-locale.js
    ...
    var user_locale = userLocaleMiddleware; // CONCATENATED MODULE: ./node_modules/@wordpress/api-fetch/build-module/utils/response.js
    ...
    var media_upload = mediaUploadMiddleware; // CONCATENATED MODULE: ./node_modules/@wordpress/api-fetch/build-module/index.js
    ...
    var build_module_defaultFetchHandler = function defaultFetchHandler(nextOptions) {
      var url = nextOptions.url,
          ...
          remainingOptions = Object(objectWithoutProperties["a"
      /* default */
      ])(nextOptions, ["url", "path", "data", "parse"]);
