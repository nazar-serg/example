...
/******/
{
  ...
  function _(module, exports) {
    (function () {
      module.exports = this["wp"]["editPost"];
    })();
    /***/
  ...
  function _(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["a"] = starFilled;
    /***/
  },
  ...
  function _(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["a"] = starEmpty;
    /***/
  },
  ...
  function _(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.r(__webpack_exports__); // NAMESPACE OBJECT: ./node_modules/@wordpress/block-directory/build-module/store/selectors.js
    ...
    __webpack_require__.d(selectors_namespaceObject, "isRequestingDownloadableBlocks", function () {
      return isRequestingDownloadableBlocks;
    });

    __webpack_require__.d(selectors_namespaceObject, "getDownloadableBlocks", function () {
      return selectors_getDownloadableBlocks;
    });

    __webpack_require__.d(selectors_namespaceObject, "getInstalledBlockTypes", function () {
      return getInstalledBlockTypes;
    });

    __webpack_require__.d(selectors_namespaceObject, "getNewBlockTypes", function () {
      return getNewBlockTypes;
    });

    __webpack_require__.d(selectors_namespaceObject, "getUnusedBlockTypes", function () {
      return getUnusedBlockTypes;
    });

    __webpack_require__.d(selectors_namespaceObject, "isInstalling", function () {
      return isInstalling;
    });

    __webpack_require__.d(selectors_namespaceObject, "getErrorNotices", function () {
      return getErrorNotices;
    });

    __webpack_require__.d(selectors_namespaceObject, "getErrorNoticeForBlock", function () {
    ...
    __webpack_require__.d(actions_namespaceObject, "fetchDownloadableBlocks", function () {
      return fetchDownloadableBlocks;
    });

    __webpack_require__.d(actions_namespaceObject, "receiveDownloadableBlocks", function () {
      return receiveDownloadableBlocks;
    });

    __webpack_require__.d(actions_namespaceObject, "installBlockType", function () {
      return actions_installBlockType;
    });

    __webpack_require__.d(actions_namespaceObject, "uninstallBlockType", function () {
      return actions_uninstallBlockType;
    });

    __webpack_require__.d(actions_namespaceObject, "addInstalledBlockType", function () {
      return addInstalledBlockType;
    });

    __webpack_require__.d(actions_namespaceObject, "removeInstalledBlockType", function () {
      return removeInstalledBlockType;
    });

    __webpack_require__.d(actions_namespaceObject, "setIsInstalling", function () {
      return setIsInstalling;
    });

    __webpack_require__.d(actions_namespaceObject, "setErrorNotice", function () {
      return setErrorNotice;
    });

    __webpack_require__.d(actions_namespaceObject, "clearErrorNotice", function () {
      return clearErrorNotice;
    }); // EXTERNAL MODULE: external {"this":["wp","notices"]}


    var external_this_wp_notices_ = __webpack_require__(94); // EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/defineProperty.js
    ...
    var external_this_wp_dataControls_ = __webpack_require__(32); // EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/toConsumableArray.js + 2 modules


    var toConsumableArray = __webpack_require__(17); // EXTERNAL MODULE: external {"this":"lodash"}


    var external_this_lodash_ = __webpack_require__(2); // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/store/reducer.js
      ...
      switch (action.type) {
        case 'ADD_INSTALLED_BLOCK_TYPE':
          return _objectSpread(_objectSpread({}, state), {}, {
            installedBlockTypes: [].concat(Object(toConsumableArray["a"
            /* default */
            ])(state.installedBlockTypes), [action.item])
          });
        ...
        case 'SET_INSTALLING_BLOCK':
          return _objectSpread(_objectSpread({}, state), {}, {
            isInstalling: _objectSpread(_objectSpread({}, state.isInstalling), {}, Object(defineProperty["a"
            /* default */
    ...
    var external_this_wp_i18n_ = __webpack_require__(1); // EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js


    var asyncToGenerator = __webpack_require__(45); // EXTERNAL MODULE: external {"this":["wp","apiFetch"]}
    ...
    /*#__PURE__*/
    __webpack_require__.n(external_this_wp_apiFetch_); // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/store/controls.js
      ...
      LOAD_ASSETS: function LOAD_ASSETS() {
        ...
        return external_this_wp_apiFetch_default()({
          ...
          function () {
            ...
            /*#__PURE__*/
            external_this_regeneratorRuntime_default.a.mark(function _callee(resolve, reject) {
              var i;
    ...
    var store_controls = controls; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/store/utils/get-plugin-url.js
    ...
    var _marked =
    /*#__PURE__*/
    external_this_regeneratorRuntime_default.a.mark(actions_installBlockType),
        _marked2 =
    /*#__PURE__*/
    external_this_regeneratorRuntime_default.a.mark(actions_uninstallBlockType);
      ...
      return external_this_regeneratorRuntime_default.a.wrap(function installBlockType$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 16:
              response = _context.sent; // Add the `self` link for newly-installed blocks.
    ...
    var build_module_store = store; // EXTERNAL MODULE: external {"this":["wp","element"]}

    var external_this_wp_element_ = __webpack_require__(0); // EXTERNAL MODULE: external {"this":["wp","plugins"]}


    var external_this_wp_plugins_ = __webpack_require__(77); // EXTERNAL MODULE: external {"this":["wp","hooks"]}


    var external_this_wp_hooks_ = __webpack_require__(33); // EXTERNAL MODULE: external {"this":["wp","blocks"]}


    var external_this_wp_blocks_ = __webpack_require__(11); // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/auto-block-uninstaller/index.js
    ...
    var slicedToArray = __webpack_require__(12); // EXTERNAL MODULE: external {"this":["wp","blockEditor"]}


    var external_this_wp_blockEditor_ = __webpack_require__(6); // EXTERNAL MODULE: external {"this":["wp","compose"]}


    var external_this_wp_compose_ = __webpack_require__(10); // EXTERNAL MODULE: external {"this":["wp","components"]}


    var external_this_wp_components_ = __webpack_require__(3); // EXTERNAL MODULE: external {"this":["wp","a11y"]}


    var external_this_wp_a11y_ = __webpack_require__(46); // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/downloadable-block-author-info/index.js
    ...
    var downloadable_block_author_info = DownloadableBlockAuthorInfo; // EXTERNAL MODULE: external {"this":["wp","htmlEntities"]}

    var external_this_wp_htmlEntities_ = __webpack_require__(69); // EXTERNAL MODULE: ./node_modules/@wordpress/icons/build-module/icon/index.js


    var build_module_icon = __webpack_require__(141); // EXTERNAL MODULE: ./node_modules/@wordpress/icons/build-module/library/star-filled.js


    var star_filled = __webpack_require__(302); // EXTERNAL MODULE: external {"this":["wp","primitives"]}


    var external_this_wp_primitives_ = __webpack_require__(7); // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/star-half.js
    ...
    var star_half = starHalf; // EXTERNAL MODULE: ./node_modules/@wordpress/icons/build-module/library/star-empty.js

    var star_empty = __webpack_require__(303); // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/block-ratings/stars.js
    ...
    function Stars(_ref) {
      ...
      return Object(external_this_wp_element_["createElement"])("div", {
        ...
        return Object(external_this_wp_element_["createElement"])(build_module_icon["a"
        /* default */
        ], {
    ...
    var block_ratings_stars = Stars; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/block-ratings/index.js
    ...
    var block_ratings = block_ratings_BlockRatings; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/downloadable-block-icon/index.js
    ...
    var downloadable_block_icon = DownloadableBlockIcon; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/downloadable-block-header/index.js
    ...
    var downloadable_block_header = DownloadableBlockHeader; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/chart-line.js
    ...
    var chart_line = chartLine; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/update.js
    ...
    var library_update = update; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/downloadable-block-info/index.js
    ...
    var downloadable_block_info = DownloadableBlockInfo; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/downloadable-block-notice/index.js
    ...
    var downloadable_block_notice = downloadable_block_notice_DownloadableBlockNotice; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/downloadable-block-list-item/index.js
    ...
    var downloadable_blocks_list = DownloadableBlocksList; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/downloadable-blocks-panel/index.js
    ...
    var downloadable_blocks_panel = Object(external_this_wp_compose_["compose"])([Object(external_this_wp_data_["withSelect"])(function (select, _ref2) {
    ...
    var inserter_menu_downloadable_blocks_panel = InserterMenuDownloadableBlocksPanel; // EXTERNAL MODULE: external {"this":["wp","editPost"]}

    var external_this_wp_editPost_ = __webpack_require__(276); // EXTERNAL MODULE: ./node_modules/@wordpress/icons/build-module/library/block-default.js


    var block_default = __webpack_require__(207); // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/compact-list/index.js
          ...
          return installBlockType(block).then(function (success) {
            if (success) {
              ...
              var _parse = Object(external_this_wp_blocks_["parse"])(attributes.originalContent),
                  _parse2 = Object(slicedToArray["a"
              /* default */
              ])(_parse, 1),
    ...
    var get_install_missing = get_install_missing_getInstallMissing; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/plugins/index.js
