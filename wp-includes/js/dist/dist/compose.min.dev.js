...
(void 0).wp = (void 0).wp || {}, (void 0).wp.compose = function (t) {
  var e = {};
    ...
    var r = n(13),
      ...
      return function (t, e) {
        ...
        r.useEffect(function () {
          return n() ? o() : t.current && t.current.addEventListener && t.current.addEventListener("load", o), function () {
            var t = n();
        ...
        n.prototype = {
          ...
          off: function off(t, e) {
            var n = this.e || (this.e = {}),
                r = n[t],
                o = [];
            if (r && e) for (var i = 0, u = r.length; i < u; i++) {
  ...
  289: function _(t, e, n) {
    ...
    !function (o, i, u) {
      ...
      function v(t, e, n) {
        return n || (n = function () {
          if (!c) for (var t in c = {}, a) {
            t > 95 && t < 112 || a.hasOwnProperty(t) && (c[a[t]] = t);
          }
          return c;
      ...
      function b(t, e) {
        ...
        for (n = function (t) {
          ...
          r = n[o], l[r] && (r = l[r]), e && "keypress" != e && s[r] && (r = s[r], i.push("shift")), y(r) && i.push(r);
        }
      ...
      function m(t) {
        ...
        function f(t, n, o, i, u, c) {
          ...
          for ("keyup" == p && y(t) && (n = [t]), a = 0; a < e._callbacks[t].length; ++a) {
            if (f = e._callbacks[t][a], (i || !f.seq || r[f.seq] == f.level) && p == f.action && ("keypress" == p && !o.metaKey && !o.ctrlKey || (s = n, l = f.modifiers, s.sort().join(",") === l.sort().join(",")))) {
              var h = !i && f.combo == u,
                  v = i && f.seq == i && f.level == c;
              (h || v) && e._callbacks[t].splice(a, 1), d.push(f);
            }
          }
        ...
        function d(t, e, i, u) {
          ...
          for (var d = 0; d < e.length; ++d) {
            var p = d + 1 === e.length ? l : f(u || b(e[d + 1]).action);
            v(e[d], p, u, t, d);
          }
        }
        ...
        function v(t, n, r, o, i) {
          ...
          c.length > 1 ? d(t, c, n, r) : (u = b(t, r), e._callbacks[u.key] = e._callbacks[u.key] || [], f(u.key, u.modifiers, {
            type: u.action
          }, o, t, i), e._callbacks[u.key][o ? "unshift" : "push"]({
            callback: n,
        ...
        e._handleKey = function (t, e, n) {
          ...
          n.type != c || y(t) || p || a(i), u = d && "keydown" == n.type;
    ...
    !function (t) {
      if (t) {
        ...
        t.prototype.stopCallback = function (t, r, o, i) {
          ...
          if (this.bind(t, n, r), t instanceof Array) for (var o = 0; o < t.length; o++) {
            e[t[o]] = !0;
          } else e[t] = !0;
        }, t.init();
      }
  ...
  476: function _(t, e, n) {
    ...
    var j = function j(t) {
      return o(function (e) {
        var n = function (n) {
          ...
          function i() {
            var t;
            return Object(a.a)(this, i), (t = o.apply(this, arguments)).handleEvent = t.handleEvent.bind(Object(m.a)(t)), t.handleRef = t.handleRef.bind(Object(m.a)(t)), t;
          }
          ...
          return Object(f.a)(i, [{
            ...
            key: "render",
            value: function value() {
              return Object(u.createElement)(e, Object(b.a)({}, this.props.ownProps, {
                ref: this.handleRef
              }));
            }
          }]), i;
    ...
    var E = o(function (t) {
      return function (e) {
        var n = k(t);
        return Object(u.createElement)(t, Object(b.a)({}, e, {
          instanceId: n
        }));
      };
    }, "withInstanceId");
    ...
    var x = o(function (t) {
      return function (e) {
        ...
        function o() {
          var t;
          return Object(a.a)(this, o), (t = n.apply(this, arguments)).timeouts = [], t.setTimeout = t.setTimeout.bind(Object(m.a)(t)), t.clearTimeout = t.clearTimeout.bind(Object(m.a)(t)), t;
        }
        ...
        return Object(f.a)(o, [{
          ...
          key: "render",
          value: function value() {
            return Object(u.createElement)(t, Object(b.a)({}, this.props, {
      ...
      return o(function (e) {
        return function (n) {
          ...
          return Object(f.a)(o, [{
            key: "render",
            value: function value() {
              return Object(u.createElement)(e, Object(b.a)({}, this.props, this.state, {
    ...
    function M(t, e) {
      ...
      return Object(u.useEffect)(function () {
        var o;
        return r.current = new A.a(t.current, {
          text: function text() {
    ...
    var P = "undefined" != typeof window ? u.useLayoutEffect : u.useEffect;
    ...
    function L(t) {
      ...
      var s = Object(u.useCallback)(function () {
        ...
        var t;
        f.current.onDragEnd && (t = f.current).onDragEnd.apply(t, arguments);
        document.removeEventListener("mousemove", s), document.removeEventListener("mouseup", l), a(!1);
      }, []),
          d = Object(u.useCallback)(function () {
        var t;
        f.current.onDragStart && (t = f.current).onDragStart.apply(t, arguments);
        document.addEventListener("mousemove", s), document.addEventListener("mouseup", l), a(!0);
      }, []);
      return Object(u.useEffect)(function () {
        return function () {
    ...
    var q = function q(t, e) {
      ...
      Object(u.useEffect)(function () {
        ...
        if (!s) {
          var e = new I.a(l ? l.current : document);
          return Object(r.castArray)(t).forEach(function (t) {
            var n = t.split("+"),
              ...
              return t.length > 1;
                ...
                o = r.has("alt"),
                u = r.has("shift");
            if (N() && (1 === r.size && o || 2 === r.size && o && u)) throw new Error("Cannot bind ".concat(t, ". Alt and Shift+Alt modifiers are reserved for character input."));
    ...
    function H(t) {
      var e = Object(u.useState)(t && window.matchMedia(t).matches),
          n = Object(C.a)(e, 2),
          r = n[0],
          o = n[1];
      return Object(u.useEffect)(function () {
        if (t) {
          ...
          return n.addListener(e), function () {
            n.removeListener(e);
          };
        }
      }, [t]), t && r;
    ...
    var z = "undefined" != typeof window && window.navigator.userAgent.indexOf("Trident") >= 0 ? function () {
      return !0;
    } : function () {
      return H("(prefers-reduced-motion: reduce)");
    },
        F = {
      huge: 1440,
      wide: 1280,
      ...
      var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : ">=",
          n = Object(u.useContext)(G),
          r = !n && "(".concat(U[e], ": ").concat(F[t], "px)"),
          o = H(r);
      return n ? W[e](F[t], n) : o;
    };

    B.__experimentalWidthProvider = G.Provider;
    var Q = B,
        V = n(151),
        X = n.n(V).a,
        Y = n(17),
    ...
    function J(t, e) {
      return "reset" === e.type ? e.list : "append" === e.type ? [].concat(Object(Y.a)(t), [e.item]) : t;
    }

    var Z = function Z(t) {
      var e = Object(u.useReducer)(J, []),
          n = Object(C.a)(e, 2),
          r = n[0],
          o = n[1];
      return Object(u.useEffect)(function () {
