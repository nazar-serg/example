...
(void 0).wp = (void 0).wp || {}, (void 0).wp.url = function (e) {
  var t = {};
    ...
    e.exports = {
      ...
      merge: function e(t, r, i) {
        ...
        return o(t) && !o(r) && (a = c(t, i)), o(t) && o(r) ? (r.forEach(function (r, o) {
          if (n.call(t, o)) {
            var c = t[o];
            c && "object" == _typeof(c) && r && "object" == _typeof(r) ? t[o] = e(c, r, i) : t.push(r);
          } else t[o] = r;
  ...
  465: function _(e, t, r) {
    ...
    var n = r(271),
      ...
      if (e) {
        ...
        return c && u.push("[" + n.slice(c.index) + "]"), function (e, t, r) {
          for (var n = t, o = e.length - 1; o >= 0; --o) {
            var i,
                c = e[o];
            if ("[]" === c && r.parseArrays) i = [].concat(n);else {
        ...
        for (r = 0; r < s.length; ++r) {
          if (r !== f) {
            var d,
                ...
                m = h.indexOf("]="),
                b = -1 === m ? h.indexOf("=") : m + 1;
            -1 === b ? (d = t.decoder(h, i.decoder, p), y = t.strictNullHandling ? null : "") : (d = t.decoder(h.slice(0, b), i.decoder, p), y = t.decoder(h.slice(b + 1), i.decoder, p)), y && t.interpretNumericEntities && "iso-8859-1" === p && (y = c(y)), y && t.comma && y.indexOf(",") > -1 && (y = y.split(",")), o.call(a, d) ? a[d] = n.combine(a[d], y) : a[d] = y;
          }
        }
  ...
  475: function _(e, t, r) {
    ...
    function j(e) {
      for (var t = e.indexOf("?"), r = -1 !== t ? Object(b.parse)(e.substr(t + 1)) : {}, n = -1 !== t ? e.substr(0, t) : e, o = arguments.length, i = new Array(o > 1 ? o - 1 : 0), c = 1; c < o; c++) {
        i[c - 1] = arguments[c];
      }
