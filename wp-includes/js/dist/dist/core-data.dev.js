...
/******/
{
  ...
  function _(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "EntityProvider", function () {
      return (
        /* reexport */
        EntityProvider
      );
    ...
    __webpack_require__.d(__webpack_exports__, "useEntityId", function () {
      return (
        /* reexport */
        useEntityId
      );
    ...
    __webpack_require__.d(__webpack_exports__, "useEntityProp", function () {
      return (
        /* reexport */
        useEntityProp
      );
    ...
    __webpack_require__.d(__webpack_exports__, "useEntityBlockEditor", function () {
      return (
        /* reexport */
    ...
    __webpack_require__.d(build_module_actions_namespaceObject, "receiveCurrentTheme", function () {
    ...
    __webpack_require__.d(build_module_actions_namespaceObject, "deleteEntityRecord", function () {
      return deleteEntityRecord;
    });

    __webpack_require__.d(build_module_actions_namespaceObject, "editEntityRecord", function () {
      return actions_editEntityRecord;
    });
    ...
    __webpack_require__.d(build_module_selectors_namespaceObject, "__unstableGetAuthor", function () {
      return __unstableGetAuthor;
    });
    ...
    __webpack_require__.d(build_module_selectors_namespaceObject, "__experimentalGetEntityRecordNoResolver", function () {
    ...
    __webpack_require__.d(build_module_selectors_namespaceObject, "hasEntityRecords", function () {
    ...
    __webpack_require__.d(build_module_selectors_namespaceObject, "__experimentalGetDirtyEntityRecords", function () {
    ...
    __webpack_require__.d(build_module_selectors_namespaceObject, "isDeletingEntityRecord", function () {
    ...
    __webpack_require__.d(build_module_selectors_namespaceObject, "getLastEntityDeleteError", function () {
    ...
    __webpack_require__.d(build_module_selectors_namespaceObject, "getCurrentTheme", function () {
    ...
    __webpack_require__.d(resolvers_namespaceObject, "__unstableGetAuthor", function () {
      return resolvers_unstableGetAuthor;
    });
    ...
    __webpack_require__.d(resolvers_namespaceObject, "getRawEntityRecord", function () {
      return resolvers_getRawEntityRecord;
    });

    __webpack_require__.d(resolvers_namespaceObject, "getEditedEntityRecord", function () {
    ...
    __webpack_require__.d(resolvers_namespaceObject, "getCurrentTheme", function () {
    ...
    var external_this_wp_dataControls_ = __webpack_require__(32); // EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/slicedToArray.js + 1 modules


    var slicedToArray = __webpack_require__(12); // EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/toConsumableArray.js + 2 modules


    var toConsumableArray = __webpack_require__(17); // EXTERNAL MODULE: external {"this":"lodash"}


    var external_this_lodash_ = __webpack_require__(2); // EXTERNAL MODULE: external {"this":["wp","isShallowEqual"]}
    ...
    /*#__PURE__*/
    __webpack_require__.n(external_this_wp_isShallowEqual_); // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/utils/if-matching-action.js
    ...
    var if_matching_action = ifMatchingAction; // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/utils/replace-action.js
    ...
    var replace_action = replaceAction; // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/utils/conservative-map-item.js
    ...
    var on_sub_key = on_sub_key_onSubKey; // EXTERNAL MODULE: external {"this":"regeneratorRuntime"}
    ...
    var external_this_wp_i18n_ = __webpack_require__(1); // EXTERNAL MODULE: external {"this":["wp","url"]}


    var external_this_wp_url_ = __webpack_require__(30); // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/queried-data/actions.js
    ...
    var _marked =
    /*#__PURE__*/
    external_this_regeneratorRuntime_default.a.mark(deleteEntityRecord),
        _marked2 =
    /*#__PURE__*/
    ...
    function build_module_actions_ownKeys(object, enumerableOnly) {
      var keys = Object.keys(object);
    ...
    function build_module_actions_objectSpread(target) {
      for (var i = 1; i < arguments.length; i++) {
        var source = arguments[i] != null ? arguments[i] : {};

        if (i % 2) {
          build_module_actions_ownKeys(Object(source), true).forEach(function (key) {
            Object(defineProperty["a"
            /* default */
            ])(target, key, source[key]);
          });
          ...
          build_module_actions_ownKeys(Object(source)).forEach(function (key) {
            Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
          });
        }
      }
    ...
    function receiveEntityRecords(kind, name, records, query) {
      var invalidateCache = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false; // Auto drafts should not have titles, but some plugins rely on them so we can't filter this
      // on the server.
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 10:
              ...
              _Object$entries$_i = Object(slicedToArray["a"
              /* default */
              ])(_Object$entries[_i], 2), key = _Object$entries$_i[0], value = _Object$entries$_i[1];
            ...
            case 16:
              ...
              _context5.next = 20;
              return actions_editEntityRecord(kind, name, recordId, Object(defineProperty["a"
              /* default */
              ])({}, key, evaluatedValue), {
                undoIgnore: true
              });
            ...
            case 38:
              autosavePost = _context5.sent; // Autosaves need all expected fields to be present.
    ...
    var get_normalized_comma_separable = getNormalizedCommaSeparable; // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/utils/with-weak-map-cache.js
    ...
    var with_weak_map_cache = withWeakMapCache; // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/queried-data/get-query-parts.js
      ...
      for (var i = 0; i < keys.length; i++) {
        ...
        switch (key) {
          ...
          default:
            ...
            parts.stableKey += (parts.stableKey ? '&' : '') + Object(external_this_wp_url_["addQueryArgs"])('', Object(defineProperty["a"
            /* default */
            ])({}, key, value)).slice(1);
        }
      }
    ...
    var get_query_parts = with_weak_map_cache(getQueryParts); // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/queried-data/reducer.js
    ...
    function build_module_reducer_ownKeys(object, enumerableOnly) {
      var keys = Object.keys(object);
    ...
    function build_module_reducer_objectSpread(target) {
      for (var i = 1; i < arguments.length; i++) {
        var source = arguments[i] != null ? arguments[i] : {};

        if (i % 2) {
          build_module_reducer_ownKeys(Object(source), true).forEach(function (key) {
            Object(defineProperty["a"
            /* default */
            ])(target, key, source[key]);
          });
          ...
          build_module_reducer_ownKeys(Object(source)).forEach(function (key) {
            Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
          });
        }
      }
    ...
    function terms() {
      ...
      switch (action.type) {
        case 'RECEIVE_TERMS':
          return build_module_reducer_objectSpread(build_module_reducer_objectSpread({}, state), {}, Object(defineProperty["a"
          /* default */
      ...
      switch (action.type) {
        case 'RECEIVE_USER_QUERY':
          return {
            ...
            queries: build_module_reducer_objectSpread(build_module_reducer_objectSpread({}, state.queries), {}, Object(defineProperty["a"
            /* default */
            ])({}, action.queryID, Object(external_this_lodash_["map"])(action.users, function (user) {
              return user.id;
            })))
          };
      }
    ...
    function entitiesConfig() {
      ...
      switch (action.type) {
        case 'ADD_ENTITIES':
          ...
          /* default */
          ])(state), Object(toConsumableArray["a"
          /* default */
          ])(action.entities));
      }
      ...
      if (!entitiesDataReducer || newConfig !== state.config) {
        ...
        entitiesDataReducer = Object(external_this_wp_data_["combineReducers"])(Object.entries(entitiesByKind).reduce(function (memo, _ref) {
          ...
          var kindReducer = Object(external_this_wp_data_["combineReducers"])(subEntities.reduce(function (kindMemo, entityConfig) {
            return build_module_reducer_objectSpread(build_module_reducer_objectSpread({}, kindMemo), {}, Object(defineProperty["a"
            /* default */
    ...
    function reducer_undo() {
      ...
      switch (action.type) {
        ...
        case 'CREATE_UNDO_LEVEL':
          ...
          if (isUndoOrRedo) {
            nextState = Object(toConsumableArray["a"
            /* default */
            ])(state);
    ...
    var rememo = __webpack_require__(42); // EXTERNAL MODULE: external {"this":["wp","deprecated"]}
    ...
    /*#__PURE__*/
    __webpack_require__.n(external_this_wp_deprecated_); // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/name.js
    ...
    var REDUCER_KEY = 'core'; // EXTERNAL MODULE: ./node_modules/equivalent-key-map/equivalent-key-map.js

    var equivalent_key_map = __webpack_require__(108);

    var equivalent_key_map_default =
    /*#__PURE__*/
    __webpack_require__.n(equivalent_key_map); // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/queried-data/selectors.js
    ...
    var getQueriedItems = Object(rememo["a"
    /* default */
    ])(function (state) {
      var query = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    ...
    var getUserQueryResults = Object(rememo["a"
    /* default */
    ...
    var getRawEntityRecord = Object(rememo["a"
    /* default */
    ])(function (state, kind, name, key) {
    ...
    var __experimentalGetDirtyEntityRecords = Object(rememo["a"
    /* default */
    ])(function (state) {
    ...
    var getEntityRecordNonTransientEdits = Object(rememo["a"
    /* default */
    ])(function (state, kind, name, recordId) {
    ...
    var getEditedEntityRecord = Object(rememo["a"
    /* default */
    ])(function (state, kind, name, recordId) {
    ...
    var getReferenceByDistinctEdits = Object(rememo["a"
    /* default */
    ])(function () {
      return [];
    }, function (state) {
    ...
    var if_not_resolved = if_not_resolved_ifNotResolved; // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/resolvers.js
    ...
    external_this_regeneratorRuntime_default.a.mark(resolvers_getAuthors),
        resolvers_marked2 =
    /*#__PURE__*/
    external_this_regeneratorRuntime_default.a.mark(resolvers_unstableGetAuthor),
        resolvers_marked3 =
    /*#__PURE__*/
    ...
    external_this_regeneratorRuntime_default.a.mark(resolvers_getEntityRecords),
        resolvers_marked6 =
    /*#__PURE__*/
    external_this_regeneratorRuntime_default.a.mark(resolvers_getCurrentTheme),
        _marked7 =
    /*#__PURE__*/
            ...
            case 8:
              if (query !== undefined && query._fields) {
                ...
                query = resolvers_objectSpread(resolvers_objectSpread({}, query), {}, {
                  _fields: Object(external_this_lodash_["uniq"])([].concat(Object(toConsumableArray["a"
                  /* default */
                  ])(get_normalized_comma_separable(query._fields) || []), [entity.key || DEFAULT_ENTITY_KEY])).join()
                });
      ...
      return external_this_regeneratorRuntime_default.a.wrap(function getEntityRecords$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 12:
              _context5.t1 = _context5.sent;
              records = _context5.t0.values.call(_context5.t0, _context5.t1); // If we request fields but the result doesn't contain the fields,
    ...
    var external_this_wp_element_ = __webpack_require__(0); // EXTERNAL MODULE: external {"this":["wp","blocks"]}


    var external_this_wp_blocks_ = __webpack_require__(11); // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/entity-provider.js


    function entity_provider_ownKeys(object, enumerableOnly) {
      var keys = Object.keys(object);
    ...
    function entity_provider_objectSpread(target) {
      for (var i = 1; i < arguments.length; i++) {
        var source = arguments[i] != null ? arguments[i] : {};

        if (i % 2) {
          entity_provider_ownKeys(Object(source), true).forEach(function (key) {
            Object(defineProperty["a"
            /* default */
            ])(target, key, source[key]);
          });
          ...
          entity_provider_ownKeys(Object(source)).forEach(function (key) {
            Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
          });
        }
      }
    ...
    function useEntityProp(kind, type, prop, _id) {
      ...
      var setValue = Object(external_this_wp_element_["useCallback"])(function (newValue) {
        editEntityRecord(kind, type, id, Object(defineProperty["a"
        /* default */
        ])({}, prop, newValue));
      }, [kind, type, id, prop]);
    ...
    function useEntityBlockEditor(kind, type) {
      ...
      var _useEntityProp3 = useEntityProp(kind, type, blocksProp, id),
          _useEntityProp4 = Object(slicedToArray["a"
      /* default */
      ])(_useEntityProp3, 2),
