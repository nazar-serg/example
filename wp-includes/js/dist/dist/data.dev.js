...
/******/
{
  ...
  function _(module, __webpack_exports__, __webpack_require__) {
    ...
    var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(13);
    /* harmony import */
  ...
  function _(module, __webpack_exports__, __webpack_require__) {
    ...
    (function (global, module) {
      /* harmony import */
      var _ponyfill_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(291);
      /* global window */
      ...
      /* WEBPACK VAR INJECTION */
    }).call(this, __webpack_require__(121), __webpack_require__(443)(module));
    /***/
  },
  ...
  function _(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "combineReducers", function () {
      return (
        /* reexport */
        turbo_combine_reducers_default.a
      );
    });
    ...
    __webpack_require__.d(__webpack_exports__, "__experimentalResolveSelect", function () {
      return (
        /* binding */
        build_module_experimentalResolveSelect
      );
    });
    ...
    var turbo_combine_reducers_default =
    /*#__PURE__*/
    __webpack_require__.n(turbo_combine_reducers); // EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/slicedToArray.js + 1 modules


    var slicedToArray = __webpack_require__(12); // EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/defineProperty.js


    var defineProperty = __webpack_require__(5); // EXTERNAL MODULE: external {"this":"lodash"}


    var external_this_lodash_ = __webpack_require__(2); // EXTERNAL MODULE: ./node_modules/memize/index.js
    ...
    var memize_default =
    /*#__PURE__*/
    __webpack_require__.n(memize); // EXTERNAL MODULE: external {"this":"regeneratorRuntime"}
    ...
    /*#__PURE__*/
    __webpack_require__.n(external_this_regeneratorRuntime_); // EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js


    var asyncToGenerator = __webpack_require__(45); // EXTERNAL MODULE: ./node_modules/symbol-observable/es/index.js


    var es = __webpack_require__(201); // CONCATENATED MODULE: ./node_modules/redux/es/redux.js
    ...
    if (false) {} // EXTERNAL MODULE: ./node_modules/equivalent-key-map/equivalent-key-map.js
    ...
    /*#__PURE__*/
    __webpack_require__.n(equivalent_key_map); // EXTERNAL MODULE: external {"this":["wp","reduxRoutine"]}


    var external_this_wp_reduxRoutine_ = __webpack_require__(290);

    var external_this_wp_reduxRoutine_default =
    /*#__PURE__*/
    __webpack_require__.n(external_this_wp_reduxRoutine_); // EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/toConsumableArray.js + 2 modules


    var toConsumableArray = __webpack_require__(17); // CONCATENATED MODULE: ./node_modules/@wordpress/data/build-module/factory.js
    ...
    var builtinControls = (_builtinControls = {}, Object(defineProperty["a"
    /* default */
    ])(_builtinControls, SELECT, createRegistryControl(function (registry) {
      return function (_ref) {
        ...
        var storeKey = _ref.storeKey,
            ...
            args = _ref.args;
        return (_registry$select = registry.select(storeKey))[selectorName].apply(_registry$select, Object(toConsumableArray["a"
        /* default */
        ])(args));
      };
    })), Object(defineProperty["a"
    /* default */
    ])(_builtinControls, RESOLVE_SELECT, createRegistryControl(function (registry) {
      return function (_ref2) {
        ...
        return (_registry$method = registry[method](storeKey))[selectorName].apply(_registry$method, Object(toConsumableArray["a"
        /* default */
        ])(args));
      };
    })), Object(defineProperty["a"
    /* default */
    ])(_builtinControls, DISPATCH, createRegistryControl(function (registry) {
      return function (_ref3) {
        ...
        var storeKey = _ref3.storeKey,
            ...
            args = _ref3.args;
        return (_registry$dispatch = registry.dispatch(storeKey))[actionName].apply(_registry$dispatch, Object(toConsumableArray["a"
        /* default */
        ])(args));
      };
    })), _builtinControls); // EXTERNAL MODULE: ./node_modules/is-promise/index.js

    var is_promise = __webpack_require__(154);

    var is_promise_default =
    /*#__PURE__*/
    __webpack_require__.n(is_promise); // CONCATENATED MODULE: ./node_modules/@wordpress/data/build-module/promise-middleware.js
    ...
    var promise_middleware = promise_middleware_promiseMiddleware; // CONCATENATED MODULE: ./node_modules/@wordpress/data/build-module/resolvers-cache-middleware.js
          ...
          return function (action) {
            ...
            Object.entries(resolvers).forEach(function (_ref) {
              ...
              resolversByArgs.forEach(function (value, args) {
                ...
                if (value !== false || !resolver.shouldInvalidate.apply(resolver, [action].concat(Object(toConsumableArray["a"
                /* default */
                ])(args)))) {
                  return;
    ...
    var resolvers_cache_middleware = resolvers_cache_middleware_createResolversCacheMiddleware; // CONCATENATED MODULE: ./node_modules/@wordpress/data/build-module/namespace-store/metadata/utils.js
    ...
    var metadata_reducer = reducer_isResolved; // CONCATENATED MODULE: ./node_modules/@wordpress/data/build-module/namespace-store/metadata/selectors.js
    ...
    function namespace_store_ownKeys(object, enumerableOnly) {
      var keys = Object.keys(object);
    ...
    function namespace_store_objectSpread(target) {
      for (var i = 1; i < arguments.length; i++) {
        var source = arguments[i] != null ? arguments[i] : {};

        if (i % 2) {
          namespace_store_ownKeys(Object(source), true).forEach(function (key) {
            Object(defineProperty["a"
            /* default */
            ])(target, key, source[key]);
          });
          ...
          namespace_store_ownKeys(Object(source)).forEach(function (key) {
            Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
          });
        }
      }
      ...
      var mapSelector = function mapSelector(selector, selectorName) {
        ...
        var selectorResolver = function selectorResolver() {
          ...
          function _fulfillSelector() {
            _fulfillSelector = Object(asyncToGenerator["a"
            /* default */
            ])(
            /*#__PURE__*/
            external_this_regeneratorRuntime_default.a.mark(function _callee2() {
    ...
    function _fulfillResolver() {
      _fulfillResolver = Object(asyncToGenerator["a"
      /* default */
      ])(
      /*#__PURE__*/
      external_this_regeneratorRuntime_default.a.mark(function _callee3(store, resolvers, selectorName) {
        var resolver,
            _len4,
            args,
            _key4,
      ...
      return {
        getSelectors: function getSelectors() {
          return ['getIsResolving', 'hasStartedResolution', 'hasFinishedResolution', 'isResolving', 'getCachedResolvers'].reduce(function (memo, selectorName) {
            return store_objectSpread(store_objectSpread({}, memo), {}, Object(defineProperty["a"
            /* default */
    ...
    var build_module_store = createCoreDataStore; // CONCATENATED MODULE: ./node_modules/@wordpress/data/build-module/registry.js

    function registry_ownKeys(object, enumerableOnly) {
      var keys = Object.keys(object);
    ...
    function registry_objectSpread(target) {
      for (var i = 1; i < arguments.length; i++) {
        var source = arguments[i] != null ? arguments[i] : {};

        if (i % 2) {
          registry_ownKeys(Object(source), true).forEach(function (key) {
            Object(defineProperty["a"
            /* default */
            ])(target, key, source[key]);
          });
          ...
          registry_ownKeys(Object(source)).forEach(function (key) {
            Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
          });
        }
      }
    ...
    var default_registry = createRegistry(); // EXTERNAL MODULE: external {"this":["wp","deprecated"]}

    var external_this_wp_deprecated_ = __webpack_require__(36);

    var external_this_wp_deprecated_default =
    /*#__PURE__*/
    __webpack_require__.n(external_this_wp_deprecated_); // CONCATENATED MODULE: ./node_modules/@wordpress/data/build-module/plugins/controls/index.js
    ...
    var plugins_controls = function plugins_controls(registry) {
    ...
    var object = object_storage; // CONCATENATED MODULE: ./node_modules/@wordpress/data/build-module/plugins/persistence/storage/default.js
    ...
    var storage_default = default_storage; // CONCATENATED MODULE: ./node_modules/@wordpress/data/build-module/plugins/persistence/index.js

    function persistence_ownKeys(object, enumerableOnly) {
      var keys = Object.keys(object);
    ...
    function persistence_objectSpread(target) {
      for (var i = 1; i < arguments.length; i++) {
        var source = arguments[i] != null ? arguments[i] : {};

        if (i % 2) {
          persistence_ownKeys(Object(source), true).forEach(function (key) {
            Object(defineProperty["a"
            /* default */
            ])(target, key, source[key]);
          });
          ...
          persistence_ownKeys(Object(source)).forEach(function (key) {
            Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
          });
        }
      }
    ...
    function createPersistenceInterface(options) {
      ...
      function setData(key, value) {
        data = persistence_objectSpread(persistence_objectSpread({}, data), {}, Object(defineProperty["a"
        /* default */
        ])({}, key, value));
      ...
      function createPersistOnChange(getState, reducerKey, keys) {
        ...
        if (Array.isArray(keys)) {
          ...
          var reducers = keys.reduce(function (accumulator, key) {
            return Object.assign(accumulator, Object(defineProperty["a"
            /* default */
    ...
    var plugins_persistence = persistencePlugin; // CONCATENATED MODULE: ./node_modules/@wordpress/data/build-module/plugins/index.js
    // EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/extends.js

    var esm_extends = __webpack_require__(8); // EXTERNAL MODULE: external {"this":["wp","element"]}


    var external_this_wp_element_ = __webpack_require__(0); // EXTERNAL MODULE: external {"this":["wp","compose"]}


    var external_this_wp_compose_ = __webpack_require__(10); // EXTERNAL MODULE: ./node_modules/use-memo-one/dist/use-memo-one.esm.js


    var use_memo_one_esm = __webpack_require__(153); // EXTERNAL MODULE: external {"this":["wp","priorityQueue"]}


    var external_this_wp_priorityQueue_ = __webpack_require__(152); // EXTERNAL MODULE: external {"this":["wp","isShallowEqual"]}
    ...
    /*#__PURE__*/
    __webpack_require__.n(external_this_wp_isShallowEqual_); // CONCATENATED MODULE: ./node_modules/@wordpress/data/build-module/components/registry-provider/context.js
    ...
    var context = Provider; // CONCATENATED MODULE: ./node_modules/@wordpress/data/build-module/components/registry-provider/use-registry.js
    ...
    var async_mode_provider_context = context_Provider; // CONCATENATED MODULE: ./node_modules/@wordpress/data/build-module/components/async-mode-provider/use-async-mode.js
    ...
    function useSelect(_mapSelect, deps) {
      ...
      var queueContext = Object(use_memo_one_esm["a"
      /* useMemoOne */
      ])(function () {
        return {
          queue: true
      ...
      var _useReducer = Object(external_this_wp_element_["useReducer"])(function (s) {
        return s + 1;
          ...
          _useReducer2 = Object(slicedToArray["a"
      /* default */
      ])(_useReducer, 2),
    ...
    var with_select_withSelect = function withSelect(mapSelectToProps) {
      return Object(external_this_wp_compose_["createHigherOrderComponent"])(function (WrappedComponent) {
        return Object(external_this_wp_compose_["pure"])(function (ownProps) {
          ...
          return Object(external_this_wp_element_["createElement"])(WrappedComponent, Object(esm_extends["a"
          /* default */
          ])({}, ownProps, mergeProps));
        });
      }, 'withSelect');
    ...
    var with_select = with_select_withSelect; // CONCATENATED MODULE: ./node_modules/@wordpress/data/build-module/components/use-dispatch/use-dispatch-with-map.js
    ...
    var use_dispatch_with_map_useDispatchWithMap = function useDispatchWithMap(dispatchMap, deps) {
      ...
      }, [registry].concat(Object(toConsumableArray["a"
      /* default */
      ])(deps)));
    };
    /* harmony default export */
    ...
    var use_dispatch_with_map = use_dispatch_with_map_useDispatchWithMap; // CONCATENATED MODULE: ./node_modules/@wordpress/data/build-module/components/with-dispatch/index.js
    ...
    var with_dispatch = with_dispatch_withDispatch; // CONCATENATED MODULE: ./node_modules/@wordpress/data/build-module/components/with-registry/index.js
    ...
    var with_registry = withRegistry; // CONCATENATED MODULE: ./node_modules/@wordpress/data/build-module/components/use-dispatch/use-dispatch.js
    ...
    var use_dispatch = use_dispatch_useDispatch; // CONCATENATED MODULE: ./node_modules/@wordpress/data/build-module/index.js
