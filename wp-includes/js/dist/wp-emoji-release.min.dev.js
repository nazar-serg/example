...
var twemoji = function () {
    ...
    parse: function parse(d, u) {
      ...
      return ("string" == typeof d ? function (d, b) {
        return o(d, function (d) {
          ...
          if (e && a) {
            for (f in c = "<img ".concat('class="', b.className, '" ', 'draggable="false" ', 'alt="', d, '"', ' src="', a, '"'), u = b.attributes(d, e)) {
        ...
        var f,
          ...
          for (; b--;) {
            c = a[b], 3 === (e = c.nodeType) ? f.push(c) : 1 !== e || "ownerSVGElement" in c || h.test(c.nodeName.toLowerCase()) || d(c, f);
          }
  ...
  function i(d, u) {
    for (var f = [], c = 0, e = 0, a = 0; a < d.length;) {
      c = d.charCodeAt(a++), e ? (f.push((65536 + (e - 55296 << 10) + (c - 56320)).toString(16)), e = 0) : 55296 <= c && c <= 56319 ? e = c : f.push(c.toString(16));
    }
