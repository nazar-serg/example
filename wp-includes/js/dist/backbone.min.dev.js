...
!function (n) {
  ...
  var a,
    ...
    } else if (i && u.test(i)) for (r = i.split(u); o < r.length; o++) {
      e = t(e, r[o], n, s);
    } else e = t(e, i, n, s);
  ...
  b.extend(v.prototype, n, {
    ...
    set: function set(t, e, i) {
      ...
      var n;
      if ("object" == _typeof(t) ? (n = t, i = e) : (n = {})[t] = e, i = i || {}, !this._validate(n, i)) return !1;
      var s = i.unset,
          r = i.silent,
          o = [],
          t = this._changing;
      ...
      for (h in n) {
        e = n[h], b.isEqual(a[h], e) || o.push(h), b.isEqual(c[h], e) ? delete u[h] : u[h] = e, s ? delete a[h] : a[h] = e;
      }
  ...
  b.extend(m.prototype, n, {
    ...
    set: function set(t, e) {
      if (null != t) {
        ...
        for (var s, r = [], o = [], h = [], a = [], u = {}, c = e.add, l = e.merge, d = e.remove, f = !1, p = this.comparator && null == n && !1 !== e.sort, g = b.isString(this.comparator) ? this.comparator : null, v = 0; v < t.length; v++) {
          s = t[v];

          var m,
              _ = this.get(s);

          _ ? (l && s !== _ && (m = this._isModel(s) ? s.attributes : s, e.parse && (m = _.parse(m, e)), _.set(m, e), h.push(_), p && !f && (f = _.hasChanged(g))), u[_.cid] || (u[_.cid] = !0, r.push(_)), t[v] = _) : c && (s = t[v] = this._prepareModel(s, e)) && (o.push(s), this._addReference(s, e), u[s.cid] = !0, r.push(s));
        }

        if (d) {
          for (v = 0; v < this.length; v++) {
            u[(s = this.models[v]).cid] || a.push(s);
          }

          a.length && this._removeModels(a, e);
        }

        var y = !1,
            d = !p && c && d;

        if (r.length && d ? (y = this.length !== r.length || b.some(this.models, function (t, e) {
          return t !== r[e];
        }), this.models.length = 0, x(this.models, r, 0), this.length = this.models.length) : o.length && (p && (f = !0), x(this.models, o, null == n ? this.length : n), this.length = this.models.length), f && this.sort({
          silent: !0
        }), !e.silent) {
          for (v = 0; v < o.length; v++) {
            null != n && (e.index = n + v), (s = o[v]).trigger("add", s, this, e);
          }

          (f || y) && this.trigger("sort", this, e), (o.length || a.length || h.length) && (e.changes = {
            added: o,
            removed: a,
            merged: h
  ...
  b.extend(e.prototype, n, {
    ...
    delegateEvents: function delegateEvents(t) {
      ...
      for (var e in this.undelegateEvents(), t) {
        var i,
            n = t[e];
        (n = !b.isFunction(n) ? this[n] : n) && (i = e.match(T), this.delegate(i[1], i[2], n.bind(this)));
      }
  ...
  O.started = !1, b.extend(O.prototype, n, {
    ...
    navigate: function navigate(t, e) {
      ...
      if (this.fragment !== i) {
        if (this.fragment = i, this._usePushState) this.history[e.replace ? "replaceState" : "pushState"]({}, document.title, n);else {
