...
window.wpCookies = {
  ...
  get: function get(e) {
    ...
    if (n) {
      if (-1 === (t = n.indexOf("; " + i))) {
        if (0 !== (t = n.indexOf(i))) return null;
      } else t += 2;

      return -1 === (e = n.indexOf(";", t)) && (e = n.length), decodeURIComponent(n.substring(t + i.length, e));
    }
  },
  ...
  if ("object" != (typeof userSettings === "undefined" ? "undefined" : _typeof(userSettings))) return !1;
