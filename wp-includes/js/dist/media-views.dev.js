...
function (module, exports) {
  ...
  /** @lends wp.media.view.Modal.prototype */
  {
    ...
    open: function open() {
      ...
      this.$('.media-modal').focus(); // Hide the page content from assistive technologies.
    ...
    close: function close(options) {
      ...
      $('body').removeClass('modal-open'); // Hide modal and remove restricted media modal tab focus once it's closed.
      ...
      if (null !== this.clickedOpenerEl) {
        ...
        $('#wpbody-content').attr('tabindex', '-1').focus();
      }
...
function (module, exports) {
  ...
  /** @lends wp.media.view.Attachments.prototype */
  {
    ...
    initialize: function initialize() {
      ...
      this.controller.on('library:selection:add', this.attachmentFocus, this); // Throttle the scroll handler and bind this.
...
function (module, exports) {
  ...
  /** @lends wp.media.view.AttachmentsBrowser.prototype */
  {
    ...
    initialize: function initialize() {
      ...
      this.createAttachmentsHeading(); // Create the list of attachments.

      this.createAttachments(); // For accessibility reasons, place the normal sidebar after the attachments, see ticket #36909.
      ...
      this.collection.on('add remove reset', this.updateContent, this); // The non-cached or cached attachments query has completed.
  ...
  /** @lends wp.media.view.Attachment.Details.prototype */
  {
    ...
    copyAttachmentDetailsURLClipboard: function copyAttachmentDetailsURLClipboard() {
      ...
      clipboard.on('success', function (event) {
        ...
        triggerElement.focus(); // Show success visual feedback.
    ...
    moveFocusToLastFallback: function moveFocusToLastFallback() {
      ...
      $('.media-frame').attr('tabindex', '-1').focus();
    },
