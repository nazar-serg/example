...
(function () {
  ...
  v.each = v.forEach = function (n, t, r) {
    if (t = y(t, r), j(n)) for (u = 0, i = n.length; u < i; u++) {
      t(n[u], u, n);
    } else for (var e = v.keys(n), u = 0, i = e.length; u < i; u++) {
      t(n[e[u]], e[u], n);
    }
    return n;
    ...
    var r,
        ...
        i = -1 / 0,
        o = -1 / 0;
    if (null == e && null != n) for (var a = 0, c = (n = j(n) ? n : v.values(n)).length; a < c; a++) {
      r = n[a], i < r && (i = r);
  ...
  v.keys = function (n) {
    ...
    var e,
        ...
        o = n;
    if (null == o) return i;
    v.isFunction(t) ? (u = v.allKeys(o), e = y(t, r)) : (u = A(arguments, !1, !1, 1), e = function e(n, t, r) {
      return t in r;
    }, o = Object(o));
  ...
  }), "function" != typeof /./ && "object" != (typeof Int8Array === "undefined" ? "undefined" : _typeof(Int8Array)) && (v.isFunction = function (n) {
