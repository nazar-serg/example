  ...
  if ("undefined" === typeof FormData || !FormData.prototype.keys) {
    var N = function N(a, b) {
      ...
      return a;
        ...
        R = "object" === (typeof window === "undefined" ? "undefined" : _typeof(window)) ? window : "object" === (typeof self === "undefined" ? "undefined" : _typeof(self)) ? self : this,
        S = R.FormData,
    ...
    [["append", O], ["delete", P], ["get", P], ["getAll", P], ["has", P], ["set", O]].forEach(function (c) {
    ...
    T && (XMLHttpRequest.prototype.send = function (c) {
      c instanceof Y ? (c = c._blob(), this.setRequestHeader("Content-Type", c.type), T.call(this, c)) : T.call(this, c);
    });
