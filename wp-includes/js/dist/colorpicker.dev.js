...
function getAnchorPosition(anchorname) {
  ...
  var x = 0,
      y = 0; // Browser capability sniffing
...
function PopupWindow() {
  ...
  this.offsetX = 0;
  this.offsetY = 0; // Method mappings
...
function ColorPicker() {
  var windowMode = false; // Create a new PopupWindow object
  ...
  cp.currentValue = "#FFFFFF"; // Method Mappings

  cp.writeDiv = ColorPicker_writeDiv;
  cp.highlightColor = ColorPicker_highlightColor;
  cp.show = ColorPicker_show;
  cp.select = ColorPicker_select; // Code to populate color picker window
