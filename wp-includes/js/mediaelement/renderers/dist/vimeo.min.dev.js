  ...
  1: [function (e, t, n) {
    ...
    var T = {
      ...
      create: function create(f, e, t) {
        ...
        }, r = mejs.html5media.properties, i = function i(_i) {
          var e = "" + _i.substring(0, 1).toUpperCase() + _i.substring(1);
        ...
        for (var u = mejs.html5media.methods, c = function c(e) {
          h[e] = function () {
            if (null !== w) switch (e) {
              case "play":
                return y = !1, w.play();
        ...
        window["__ready__" + h.id] = function (e) {
          if (f.vimeoPlayer = w = e, v.length) for (var t = 0, n = v.length; t < n; t++) {
            var r = v[t];
          ...
          for (var o = document.getElementById(h.id), s = void 0, u = function u(e) {
